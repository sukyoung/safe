...
import kr.ac.kaist.safe.nodes.Comment;
...
public class ASTIO {
    ...
    public static final Comparator<Comment> commentComparator = new Comparator<Comment>() {
        ...
        public int compare(Comment arg0, Comment arg1) {
            SourceLoc begin0 = NodeUtil.getSpan(arg0).begin();
            SourceLoc begin1 = NodeUtil.getSpan(arg1).begin();
            if (begin0.line() == begin1.line())
                return compareTo(begin0.column(), begin1.column());
            else
                return compareTo(begin0.line(), begin1.line());
        }
    };
}
