...
public class Path {
    ...
    private static List<File> stringToFiles(String path) {
        ...
        path = JUseful.substituteVars(path);
    ...
    public String toString() {
        return JUseful.listInDelimiters("", dirs, "", pathSep);
    }

    public Path prepend(Path other) {
        return new Path(JUseful.concat(other.dirs, this.dirs));
    }

    public Path append(Path other) {
        return new Path(JUseful.concat(this.dirs, other.dirs));
    }
    ...
    public Path prepend(File f) {
        return new Path(JUseful.prepend(f, dirs));
    }
