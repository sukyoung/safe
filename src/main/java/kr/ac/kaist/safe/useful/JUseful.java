...
public class JUseful {
     ...
     * @throws IOException
     */
    public static Tuple2<FileWriter, BufferedWriter> filenameToBufferedWriter(String filename) throws IOException {
        FileWriter fw;
        try {
        ...
        return new Tuple2<FileWriter, BufferedWriter>(fw, new BufferedWriter(fw));
    }
