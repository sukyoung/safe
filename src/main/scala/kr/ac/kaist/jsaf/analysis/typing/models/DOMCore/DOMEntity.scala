...
object DOMEntity extends DOM {
  private val name = "Entity"
  ...
  // intance of DOMEntity should have 'publicId', 'systemId', 'notationName', 'inputEncoding', 'xmlEncoding', 'xmlVersion' property
}
