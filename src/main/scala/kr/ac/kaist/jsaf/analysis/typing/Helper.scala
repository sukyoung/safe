...
object Helper {
  ...
  def NewFunctionObject(fid: Option[FunctionId], cid: Option[FunctionId], env: Value,
    ...
    val o_2 = fid match {
      case Some(id) => o_1_1.update("@function", PropValue(ObjectValueBot, ValueBot, FunSet(id)))
      case None => o_1_1
    }
    val o_3 = cid match {
