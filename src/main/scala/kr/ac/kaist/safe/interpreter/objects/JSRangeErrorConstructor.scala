...
class JSRangeErrorConstructor(_I: InterpreterMain, _proto: JSObject)
  ...
  def init(): Unit = {
     ...
     */
    property.put("prototype", I.IH.mkDataProp(I.IS.RangeErrorPrototype))
  }
  ...
  def construct(message: Val): JSErrorObject =
    new JSErrorObject(I, I.IS.RangeErrorPrototype, "Error", true,
