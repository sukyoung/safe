...
class JSEvalErrorConstructor(_I: InterpreterMain, _proto: JSObject)
  ...
  def init(): Unit = {
     ...
     */
    property.put("prototype", I.IH.mkDataProp(I.IS.EvalErrorPrototype))
  }
  ...
  def construct(message: Val): JSErrorObject =
    new JSErrorObject(I, I.IS.EvalErrorPrototype, "Error", true,
