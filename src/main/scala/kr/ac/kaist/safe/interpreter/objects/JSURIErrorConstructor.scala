...
class JSURIErrorConstructor(_I: InterpreterMain, _proto: JSObject)
  ...
  def init(): Unit = {
     ...
     */
    property.put("prototype", I.IH.mkDataProp(I.IS.URIErrorPrototype))
  }
  ...
  def construct(message: Val): JSErrorObject =
    new JSErrorObject(I, I.IS.URIErrorPrototype, "Error", true,
