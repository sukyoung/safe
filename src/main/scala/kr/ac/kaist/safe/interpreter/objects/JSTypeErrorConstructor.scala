...
class JSTypeErrorConstructor(_I: InterpreterMain, _proto: JSObject)
  ...
  def init(): Unit = {
     ...
     */
    property.put("prototype", I.IH.mkDataProp(I.IS.TypeErrorPrototype))
  }
  ...
  def construct(message: Val): JSErrorObject =
    new JSErrorObject(I, I.IS.TypeErrorPrototype, "Error", true,
