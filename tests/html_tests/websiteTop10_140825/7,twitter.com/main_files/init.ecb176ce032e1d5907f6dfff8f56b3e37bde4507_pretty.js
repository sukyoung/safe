...
{            }
    ...
    function lc(a, b, c, d) 
    {
      ...
      if(q.isArray(b))
        ...
        {
          c || hc.test(a) ? d(a, e) : lc(a + "[" + (typeof e == "object" ? b : "") + "]", e, c, 
          d);
        }));
      else
...
{        }
    ...
    function Zc(a, b, c) 
    {
      ...
      j = (function () 
      {
        var b = Qc || Xc(), c = Math.max(0, k.startTime + k.duration - b), 
        d = c / k.duration || 0, 
        e = 1 - d, 
        f = 0, 
        g = k.tweens.length;
    ...
    var c, d, e = a.document, f = a.location, g = a.navigator, 
    i = a.jQuery, 
    j = a.$, 
...
{                  return setTimeout(g, 50);}
    ...
    q.extend({
      ...
      when : (function (a) 
      {
        var b = 0, c = l.call(arguments), d = c.length, e = d !== 1 || a && q.isFunction(a.promise) ? d : 0, 
        f = e === 1 ? a : q.Deferred(), 
        g = (function (a, b, c) 
        {
          return (function (d) 
...
{        b.deleteExpando = ! 1;}
      ...
      q((function () 
      {
        ...
        {
          b.pixelPosition = (a.getComputedStyle(d, null) || {
          ...
          d.style.width = "1px";
          d.appendChild(g);
          b.reliableMarginRight = ! parseFloat((a.getComputedStyle(g, null) || {
    ...
    q.extend({
      ...
      data : (function (a, c, d, e) 
      {
        if(! q.acceptData(a))
          return;
        var f, g, i = q.expando, j = typeof c == "string", k = a.nodeType, 
        l = k ? q.cache : a, 
        m = k ? a[i] : a[i] && i;
    ...
    q.extend({
      ...
      {
        b = b || "fx";
        var c = q.queue(a, b), d = c.length, e = c.shift(), f = q._queueHooks(a, b), 
        g = (function () 
        {
          q.dequeue(a, b);
        });
    ...
    q.fn.extend({
      ...
      {
        var d, e = 1, f = q.Deferred(), g = this, i = this.length, 
        j = (function () 
        {
          -- e || f.resolveWith(g, [g, ]);
        });
...
{            }
    ...
    q.extend({
      valHooks : {
        ...
        select : {
          get : (function (a) 
          {
            var b, c, d = a.options, e = a.selectedIndex, f = a.type === "select-one" || e < 0, 
            g = f ? null : [], 
            i = f ? e + 1 : d.length, 
            j = e < 0 ? i : f ? e : 0;
            for(;j < i;j ++)
    ...
    var W = /^(?:textarea|input|select)$/i, X = /^([^\.]*|)(?:\.(.+)|)$/, 
    Y = /(?:^|\s)hover(\.\S+|)\b/, 
    Z = /^key/, 
    ...
    q.event = {
      ...
      fix : (function (a) 
      {
        if(a[q.expando])
          return a;
        var b, c, d = a, f = q.event.fixHooks[a.type] || {
    ...
    q.fn.extend({
      ...
      off : (function (a, c, d) 
      {
        ...
        {
          e = a.handleObj;
          q(a.delegateTarget).off(e.namespace ? e.origType + "." + e.namespace : e.origType, 
          e.selector, 
          e.handler);
          return this;
        }
    ...
    (function (a, b) 
    {
          ...
          if(e = Q.exec(a))
            if(k = e[1])
            {
              if(l === 9)
              {
                ...
                if(b.ownerDocument && (f = b.ownerDocument.getElementById(k)) && i(b, f) && f.id === k)
                {
                  c.push(f);
                  return c;
                }
      ...
      function ob(a, b, c, d, e, f) 
      {
        ...
        {
          var k, l, m, n = [], o = [], p = g.length, q = f || rb(b || "*", i.nodeType ? [i, ] : i, []), 
          r = a && (f || ! b) ? nb(q, n, a, i, j) : q, 
          s = c ? e || (f ? a : p || d) ? [] : g : r;
          c && c(r, s, i, j);
          if(d)
          {
      ...
      function pb(a) 
      {
        var b, c, d, f = a.length, g = e.relative[a[0].type], i = g || e.relative[" "], 
        j = g ? 1 : 0, 
        k = lb((function (a) 
        {
          return a === b;
            ...
            if(c[p])
            {
              ...
              for(;d < f;d ++)
                if(e.relative[a[d].type])
                  break;
              return ob(j > 1 && mb(n), j > 1 && a.slice(0, j - 1).join("").replace(M, "$1"), 
              c, 
              j < d && pb(a.slice(j, d)), 
              d < f && pb(a = a.slice(d)), 
              d < f && a.join(""));
      ...
      function qb(a, b) 
      {
        ...
        {
          var o, p, q, r = [], t = 0, v = "0", y = i && [], z = n != null, 
          A = m, 
        ...
        if(! d && n.length === 1)
        {
          ...
          for(g = X.POS.test(a) ? - 1 : i.length - 1;g >= 0;g --)
          {
            ...
            if(e.relative[l = k.type])
              break;
            if(m = e.find[l])
              if(d = m(k.matches[0].replace(W, ""), S.test(i[0].type) && b.parentNode || b, 
              f))
              {
                i.splice(g, 1);
                a = d.length && i.join("");
      ...
      var c, d, e, f, g, i, j, k, l, m, n = ! 0, o = "undefined", 
...
{        y = (function (a) 
      ...
      s.querySelectorAll && (function () 
      {
        ...
        e = [":focus", ], 
        f = [":active", ], 
        i = t.matchesSelector || t.mozMatchesSelector || t.webkitMatchesSelector || t.oMatchesSelector || t.msMatchesSelector;
        Y((function (a) 
        {
...
{                }
    ...
    var fb = /Until$/, gb = /^(?:parents|prev(?:Until|All))/, 
    hb = /^.[^:#\[\.,]*$/, 
...
{              }
        ...
        if(this[0])
        {
          ...
          if(f)
          {
            ...
            for(i = e.cacheable || m - 1;j < m;j ++)
              d.call(c && q.nodeName(this[j], "table") ? Fb(this[j], "tbody") : this[j], 
              j === i ? g : q.clone(g, ! 0, ! 0));
          }
          g = f = null;
    ...
    q.extend({
      ...
      {
        var c, d, e, f, g = 0, i = q.expando, j = q.cache, k = q.support.deleteExpando, 
        l = q.event.special;
        for(;(e = a[g]) != null;g ++)
          if(b || q.acceptData(e))
          {
    ...
    var Kb, Lb, Mb, Nb = /alpha\([^)]*\)/i, Ob = /opacity=([^)]*)/, 
    Pb = /^(top|right|bottom|left)$/, 
    Qb = /^(none|table(?!-c[ea]).+)/, 
    Rb = /^margin/, 
    Sb = new RegExp("^(" + r + ")(.*)$", "i"), 
    Tb = new RegExp("^(" + r + ")(?!px)[a-z%]+$", "i"), 
    Ub = new RegExp("^([-+])=(" + r + ")", "i"), 
    Vb = {
      BODY : "block"
    }, 
...
{            }
    ...
    q.support.opacity || (q.cssHooks.opacity = {
      ...
      set : (function (a, b) 
      {
        var c = a.style, d = a.currentStyle, e = q.isNumeric(b) ? "alpha(opacity=" + b * 100 + ")" : "", 
    ...
    var gc = /%20/g, hc = /\[\]$/, ic = /\r?\n/g, jc = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, 
...
{              if(! (w < 2))
    ...
    {
      var f, g, i, j = c.data, k = c.url, l = c.jsonp !== ! 1, 
      m = l && Jc.test(k), 
...
{                a || f(- 1, o);}
    ...
    var Qc, Rc, Sc = /^(?:toggle|show|hide)$/, Tc = new RegExp("^(?:([-+])=|)(" + r + ")([a-z%]*)$", "i"), 
    Uc = /queueHooks$/, 
    Vc = [_c, ], 
    Wc = {
      "*" : [(function (a, b) 
      {
        var c, d, e = this.createTween(a, b), f = Tc.exec(b), g = e.cur(), 
        i = + g || 0, 
        j = 1, 
        k = 20;
        if(f)
    ...
    q.fn.extend({
      ...
      stop : (function (a, c, d) 
      {
        ...
        return this.each((function () 
        {
          var b = ! 0, c = a != null && a + "queueHooks", f = q.timers, 
          g = q._data(this);
          if(c)
            g[c] && g[c].stop && e(g[c]);
          else
      ...
      (function (d, e) 
      {
        q.fn[e] = (function (e, f) 
        {
          ...
          return q.access(this, (function (c, d, e) 
          {
            ...
            {
              f = c.documentElement;
              return Math.max(c.body["scroll" + a], f["scroll" + a], c.body["offset" + a], 
              f["offset" + a], 
              f["client" + a]);
            }
  ...
  })((function () 
  {
    ...
    var a = Function.prototype.call, b = Array.prototype, c = Object.prototype, 
    d = b.slice, 
    e = a.bind(c.toString), 
    ...
    Array.prototype.reduceRight || (Array.prototype.reduceRight = (function (b) 
    {
      ...
      do
        g in this && (f = b.call(void 0, f, c[g], g, c));while(g --);
      return f;
    }));
    ...
    if(! Object.keys)
    {
      var m = ! 0, n = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor", ], 
      o = n.length;
      for(var p in {
        toString : null
      })
    ...
    if(! Date.parse || Date.parse("+275760-09-13T00:00:00.000Z") !== 8640000000000000)
      Date = (function (a) 
      {
...
{        }
    ...
    {
      var f = "Property description must be an object: ", g = "Object.defineProperty called on non-object: ", 
...
{            }
        ...
        if(owns(d, "value"))
          if(supportsAccessors && (lookupGetter(b, c) || lookupSetter(b, c)))
          {
            var k = b.__proto__;
...
{      Object.freeze = (function (b) 
  ...
  (function (a, b) 
  {
    ...
    var c = a.attachEvent && ! a.opera, d = b.getElementsByTagName("script"), 
    e, 
...
{          return new Error("XHR not found.");}
    ...
    if(e)
    {
      L.path = e.getAttribute("data-path") || e.src.split(/loadrunner\.js/)[0] || "";
...
{          c += 1;
      ...
      var a, b, c, d = document, e = this.path, f = 'link[href="' + e + '"]', 
      g = $.browser;
      if($(f).length > 0)
  ...
  (function (a, b) 
  {
    ...
    {
      a = l(a);
      return k.test(a) ? a.replace(e, "&amp;").replace(f, "&lt;").replace(g, "&gt;").replace(i, "&#39;").replace(j, "&quot;") : a;
    }
    ...
    a.Template.prototype = {
      ...
      s : (function (a, b, c, d, e, f, g) 
      {
        ...
        if(n(a) && a.length === 0)
          return ! 1;
        typeof a == "function" && (a = this.ms(a, b, c, d, e, f, g));
        i = ! ! a;
      ...
      d : (function (a, b, d, e) 
      {
        var f, g = a.split("."), i = this.f(g[0], b, d, e), j = this.options.modelGet, 
        k = null;
        if(a === "." && n(b[b.length - 2]))
          i = b[b.length - 1];
        else
  ...
  (function () 
  {
    ...
    {
      var d = (new Date).getTime(), e = Math.max(0, 16 - (d - a)), 
  ...
  using.aliases = {
    "$bundle/boot.9e4798c1d9b06615b729a45722472f6189bd9d39.js" : ["app/ui/dialogs/age_gate_dialog", "app/ui/dialogs/block_or_report", "app/ui/dialogs/with_modal_tweet", "app/ui/dialogs/block_user_dialog", "app/ui/with_position", "app/utils/with_iframe_height_adjuster", "app/ui/dialogs/buy_now_dialog", "app/ui/dialogs/captcha_challenge_dialog", "app/utils/with_event_params", "template", "app/ui/dialogs/confirm_dialog", "app/ui/connect_badge", "lib/twitter-text", "app/utils/tweet_helper", "app/ui/with_character_counter", "app/ui/with_text_polling", "app/ui/updating_text_counter", "app/ui/dialogs/with_create_or_edit_custom_timeline_dialog", "app/ui/dialogs/create_custom_timeline_dialog", "app/ui/with_custom_timeline_create_button", "app/ui/dialogs/curate_dialog", "app/ui/dashboard", "app/ui/dialogs/delete_tweet_dialog", "app/data/sms/device_verification", "app/ui/sms/with_sms_country_selector", "app/ui/with_loading_indicator", "app/ui/sms/device_verification_banner", "app/utils/string", "app/data/direct_messages", "app/data/direct_messages_scribe", "app/utils/user_dom_data", "app/ui/direct_message_link_handler", "app/ui/typeahead/accounts_renderer", "app/ui/typeahead/saved_searches_renderer", "app/ui/typeahead/recent_searches_renderer", "app/ui/typeahead/topics_renderer", "app/ui/typeahead/trend_locations_renderer", "app/ui/typeahead/concierge_renderer", "app/ui/typeahead/selected_users_renderer", "app/utils/rtl_text", "app/ui/typeahead/typeahead_dropdown", "app/utils/caret", "app/utils/event_support", "app/utils/typeahead_helpers", "app/ui/typeahead/typeahead_input", "app/ui/with_timestamp_updating", "app/ui/with_item_actions", "app/ui/with_tweetbox_initialization", "app/ui/user_actions_dropdown", "app/ui/with_user_actions", "app/ui/with_dynamic_stylesheet", "app/ui/direct_message_dialog", "app/utils/image/image_resizer", "app/ui/direct_message_media_preview", "app/ui/direct_message_actions", "app/ui/with_draft_tweets", "app/ui/with_rtl_tweet_box", "app/ui/toolbar", "app/utils/html_text", "app/ui/with_rich_editor", "app/ui/with_upload_photo_affordance", "$lib/jquery.swfobject.js", "app/utils/image", "app/utils/drag_drop_helper", "app/ui/with_drop_events", "app/ui/with_droppable_image", "app/ui/select_users", "app/data/media_tags_scribe", "app/ui/tweet_box", "app/utils/image_thumbnail", "app/ui/tweet_box_thumbnails", "app/utils/image_resize", "app/ui/with_image_selection", "app/ui/image_selector", "app/ui/with_click_outside", "app/ui/geo_picker", "app/ui/tweet_box_manager", "app/ui/direct_message_conversation_actions", "app/data/dm/delete_conversation", "app/data/dm/view_participants", "app/boot/direct_messages", "app/data/dm_poll", "app/ui/with_drag_events", "app/ui/drag_state", "app/ui/banners/email_banner", "app/data/email_banner", "app/data/email_banner_scribe", "app/data/embed_scribe", "app/data/with_widgets", "app/ui/dialogs/embed_tweet", "app/data/feedback/feedback", "app/ui/feedback/with_feedback_tweet", "app/ui/feedback/feedback_stories", "app/ui/feedback/with_feedback_discover", "app/ui/feedback/feedback_dialog", "app/ui/feedback/feedback_report_link_handler", "app/utils/image/image_loader", "app/ui/media/with_flag_action", "app/ui/with_tweet_translation", "app/ui/gallery/gallery", "app/data/gallery_scribe", "app/ui/global_loading_indicator", "app/ui/dialogs/goto_user_dialog", "app/ui/dialogs/keyboard_shortcuts_dialog", "app/ui/dialogs/leadgen_confirm_dialog", "app/ui/dialogs/list_membership_dialog", "app/ui/dialogs/list_operations_dialog", "app/data/sms/sms_download_scribe", "app/ui/with_tweet_actions_helper", "app/utils/find_tweet", "app/ui/more_tweet_actions_dropdown", "app/utils/multiline_text_range", "app/ui/multiline_ellipses", "app/ui/navigation_links", "app/utils/setup_polling_with_backoff", "app/data/notification_listener", "app/data/oembed", "app/data/oembed_scribe", "app/data/with_boot_with_teardown_context", "app/ui/overlay_navigation", "app/data/overlay_navigation", "app/ui/page_title", "app/ui/page_visibility", "app/ui/dialogs/permalink_overlay", "app/data/profile_popup", "app/data/profile_popup_scribe", "app/ui/with_profile_stats", "app/ui/with_handle_overflow", "app/ui/profile_popup", "app/data/profile_edit_btn_scribe", "app/ui/with_hover_card", "app/ui/profile_hovercard", "app/data/with_email_follow_data", "app/data/user", "app/data/lists", "app/boot/profile_popup", "app/ui/responsive_dashboard_width", "app/ui/dialogs/retweet_dialog", "app/data/saved_searches", "app/data/saved_searches_scribe", "app/ui/search_query_source", "app/data/share_via_email_dialog_data", "app/ui/dialogs/share_via_email_dialog", "app/data/spam_challenge", "app/ui/spoonbill", "app/ui/spoonbill_producer", "app/data/geo", "app/data/with_media_upload", "app/data/tweet", "app/ui/tweet_dialog", "app/ui/new_tweet_button", "app/data/tweet_box_scribe", "app/boot/tweet_boxes", "app/ui/user_dropdown", "app/ui/signin_dropdown", "app/utils/animate_window_scrolltop", "app/ui/global_nav", "app/ui/dm_envelope", "app/ui/search_input", "app/data/search_input_scribe", "app/ui/login_form", "app/ui/track_ga_events", "app/ui/macaw_nymizer_signin_conversion", "app/boot/top_bar", "app/data/typeahead/with_cache", "app/data/with_datasource_helpers", "app/data/typeahead/accounts_datasource", "app/data/typeahead/saved_searches_datasource", "app/data/typeahead/recent_searches_datasource", "app/data/typeahead/with_external_event_listeners", "app/data/typeahead/topics_datasource", "app/data/typeahead/trend_locations_datasource", "app/data/typeahead/concierge_datasource", "app/data/typeahead/selected_users_datasource", "app/data/typeahead/prefill_users_datasource", "app/data/typeahead/typeahead", "app/data/typeahead/typeahead_scribe", "app/ui/tweet_actions", "app/ui/tweet_state_updater", "app/ui/dialogs/uz_survey", "app/data/with_scribe_data_from_dom", "app/ui/with_inline_retweet", "app/data/sms_confirmation_data", "app/ui/forms/select_box", "app/ui/with_phone_pin_verification", "app/ui/dialogs/sms_confirmation_dialog", "app/data/sms_confirmation_scribe", "app/boot/app", ],
    "$bundle/highline.9a8461c8b01fa7b893c2cbc35ec8d67d44cbd6e9.js" : ["app/ui/profile/add_header_callout", "$lib/jquery_color_picker.js", "app/ui/color_picker", "app/ui/image_edit_dialog", "app/ui/profile/inline_edit_user_color", "app/utils/blend_hex_color", "app/ui/profile/override_user_css", "app/ui/profile/profile_header_image_cropper_sync", "app/boot/highline_inline_edit", "app/ui/profile/profile_opt_in_banner", "app/ui/profile/help_prompts/profile_opt_in_help_prompts", "app/ui/profile/help_prompts/profile_help_prompt", "app/ui/profile/help_prompts/profile_add_avatar_help_prompt", "app/ui/profile/help_prompts/profile_add_header_help_prompt", "app/ui/profile/help_prompts/profile_pin_tweet_help_prompt", "app/data/profile_opt_in", "app/data/profile_opt_in_scribe", "app/data/profile_opt_in_help_prompts_scribe", "app/boot/profile_opt_in", "app/ui/profile/follower_requests_reminder", "app/ui/profile/highline_canopy", "app/ui/dm_button", "app/ui/profile/highline_profile_stats", "app/ui/profile/responsive_nav", "app/ui/profile/sidebar_arrangement", "app/ui/profile/sidebar_tweetbox", "bower_components/flight-viewport/lib/viewport", "app/boot/highline_profile", "app/utils/event_proxy", "app/ui/with_profile_tweet_stat_count_data", "app/ui/with_hover_state_removal", "app/ui/with_tweet_action_animation", "app/ui/grid_tweet_actions", "app/ui/grid_more_tweet_actions_dropdown", "app/ui/profile/highline_tweet_stats", "app/ui/timelines/with_contextual_tweet", "app/ui/timelines/with_new_grid_items", "app/ui/timelines/with_grid_keyboard_navigation", "app/ui/with_animated_tweet_removal", "app/boot/tweet_grid_timeline", "app/ui/profile/empty_timeline_owner", "app/ui/profile/empty_timeline_tweetbox", "app/ui/prefilled_tweet", "app/data/prefilled_tweet_scribe", "app/ui/profile/profile_card", "app/data/profile_card_scribe", "app/ui/profile/scroll_bumps", "app/data/profile/scroll_bump_scribe", "app/ui/dialogs/profile_scroll_bump", "app/ui/list_actions", "app/data/list_actions", "app/data/list_actions_scribe", "app/ui/profile/profile_featured_list", "app/data/profile_featured_list_scribe", "app/pages/profile/highline_landing", "app/pages/profile/highline_tweets", "app/pages/profile/highline_favorites", "app/boot/user_grid_timeline", "app/ui/profile/pending_followers_title", "app/pages/profile/highline_follower_requests", "app/pages/profile/highline_followers", "app/pages/profile/highline_following", "app/pages/profile/highline_media", "app/pages/profile/highline_lists", "app/pages/profile/highline_custom_timelines", "app/boot/event", "app/data/events/matches", "app/data/matches_scribe", "app/ui/events/canopy_scoreboard", "app/boot/sports_event", "app/pages/events/sports/highline_landing", "app/pages/events/sports/people", ],
    "$bundle/frontpage.d2c1c598d6bea53774abb7c13c08808feba31941.js" : ["app/ui/login_form", "app/data/frontpage_scribe", "app/ui/cookie_warning", "app/ui/track_ga_events", "app/ui/macaw_nymizer_signin_conversion", "app/ui/search_input", "app/data/search_input_scribe", "app/data/typeahead/with_cache", "app/utils/typeahead_helpers", "app/data/with_datasource_helpers", "app/data/typeahead/accounts_datasource", "app/data/typeahead/saved_searches_datasource", "app/data/typeahead/recent_searches_datasource", "app/data/typeahead/with_external_event_listeners", "app/data/typeahead/topics_datasource", "app/data/typeahead/trend_locations_datasource", "app/data/typeahead/concierge_datasource", "app/data/typeahead/selected_users_datasource", "app/data/typeahead/prefill_users_datasource", "app/data/typeahead/typeahead", "lib/twitter-text", "app/data/typeahead/typeahead_scribe", "app/utils/caret", "app/utils/event_support", "app/utils/string", "app/utils/rtl_text", "app/ui/typeahead/typeahead_input", "app/ui/typeahead/accounts_renderer", "app/ui/typeahead/saved_searches_renderer", "app/ui/typeahead/recent_searches_renderer", "app/ui/typeahead/topics_renderer", "app/ui/typeahead/trend_locations_renderer", "app/ui/typeahead/concierge_renderer", "app/ui/typeahead/selected_users_renderer", "app/ui/typeahead/typeahead_dropdown", "app/utils/setup_polling_with_backoff", "app/data/trends", "app/data/trends/location_dialog", "app/data/trends/recent_locations", "app/utils/scribe_event_initiators", "app/data/trends_scribe", "app/ui/with_item_actions", "app/ui/trends/with_share_trends", "app/ui/trends/trends", "app/ui/trends/trends_dialog", "app/ui/trends/dialog/with_location_info", "app/ui/trends/dialog/location_dropdown", "app/ui/trends/dialog/location_search", "app/ui/trends/dialog/current_location", "app/ui/trends/dialog/with_location_list_picker", "app/ui/trends/dialog/nearby_trends", "app/ui/trends/dialog/recent_trends", "app/ui/trends/dialog/dialog", "app/boot/trends", "app/pages/frontpage", "app/data/login_scribe", "app/pages/login", ],
    "$bundle/signup.1e8c4da3abc66996a2f89833e15262af9a27394a.js" : ["app/ui/signup/with_captcha", "app/utils/common_regexp", "app/ui/signup/with_signup_validation", "app/ui/signup/signup_form", "app/ui/with_password_strength", "app/data/signup_data", "app/data/settings", "app/data/signup_scribe", "app/ui/signup/suggestions", "app/utils/animate_window_scrolltop", "app/ui/signup/small_print_expander", "app/ui/signin_dropdown", "app/ui/signup_download/us_phone_number_checker", "app/pages/signup/signup", "app/ui/signup/country_code_select", "app/ui/signup/country_code_display", "app/ui/signup/signup_digits_scribe", "app/pages/signup/signup_digits", ],
    "$bundle/profile.f81901e38c504a679aa1db095c6f015e3a8b70f4.js" : ["app/ui/inline_edit", "app/data/async_profile", "$lib/jquery_ui.profile.js", "$lib/jquery_webcam.js", "app/ui/settings/with_cropper", "app/ui/settings/with_webcam", "app/ui/with_verify_upload_type", "app/utils/is_showing_avatar_options", "app/ui/dialogs/profile_image_upload_dialog", "app/ui/dialogs/profile_edit_error_dialog", "app/ui/dialogs/profile_confirm_image_delete_dialog", "app/ui/droppable_image", "app/data/inline_edit_scribe", "app/data/settings/profile_image_upload_scribe", "app/data/drag_and_drop_scribe", "app/ui/settings/change_photo", "app/ui/image_uploader", "app/ui/inline_profile_editing_initializor", "app/utils/hide_or_show_divider", "app/ui/with_inline_image_options", "app/ui/with_inline_image_editing", "app/ui/inline_profile_editing", "app/data/settings", "app/ui/profile_edit_param", "app/ui/edit_header_button", "app/ui/alert_banner_to_message_drawer", "app/boot/inline_edit", "app/ui/profile/canopy", "app/data/profile_canopy_scribe", "app/ui/profile/head", "app/data/profile_head_scribe", "app/ui/profile/social_proof", "app/data/profile_social_proof_scribe", "app/ui/media/card_thumbnails", "app/data/media_timeline", "app/ui/suggested_users", "app/data/suggested_users", "app/ui/profile/alcohol_brand_follower_notification", "app/ui/profile/auto_signup_dialog", "app/boot/profile", "app/pages/profile/tweets", "app/ui/timelines/with_cursor_pagination", "app/ui/with_stream_users", "app/ui/timelines/with_excluded_ids_pagination", "app/ui/timelines/user_timeline", "app/boot/user_timeline", "app/ui/timelines/follower_request_timeline", "app/data/follower_request", "app/data/follower_request_scribe", "app/pages/profile/follower_requests", "app/pages/profile/followers", "app/pages/profile/following", "app/pages/profile/favorites", "app/ui/timelines/list_timeline", "app/boot/list_timeline", "app/ui/profile/list_create_button", "app/pages/profile/lists", "app/ui/timelines/grid_timeline", "app/boot/grid_timeline", "app/pages/profile/media", "app/ui/timelines/custom_timelines_timeline", "app/boot/custom_timelines_timeline", "app/pages/profile/custom_timelines", "app/ui/dialogs/edit_custom_timeline_dialog", "app/ui/timelines/custom_timeline", "app/ui/custom_timeline_tweetbox", "app/ui/custom_timeline_follow_card", "app/ui/with_curated_tweet_removal", "app/ui/custom_timeline_tweet_actions", "app/boot/custom_timeline", "app/pages/custom_timeline", ],
    "$bundle/start.2c40d2af55e159e9be936cc7a0d23c3b83efe75b.js" : ["app/ui/timelines/with_load_more_pagination", "app/ui/timelines/with_dismissible_recommendation", "app/ui/timelines/dismissible_timeline", "app/ui/pushstate_loading_bar", "app/ui/start/follow_context", "app/data/start/follow_context", "app/ui/start/navigation_monitor", "app/ui/start/exit_confirm_dialog", "app/data/start_flow_scribe", "app/data/start/tooltip_scribe", "app/data/users", "app/ui/start/preview_timeline", "app/data/start/preview_timeline", "app/ui/start/preview_timeline_button", "app/ui/contact_import_buttons", "app/boot/start", "app/pages/start/opt_in", "app/ui/wc_select_team", "app/data/start/wc_select_team_scribe", "app/ui/start/fixed_right_rail", "app/pages/start/wc_select_team", "app/boot/customize_profile", "app/ui/welcome/customize_profile", "app/ui/thumbnail_photo_chooser", "app/pages/start/setup_profile", "app/ui/account_create_event_ga", "app/ui/macaw_nymizer_signup_conversion", "app/pages/start/import", "app/ui/start/home_popover", "app/ui/timelines/wtf_user_timeline", "app/ui/start/with_dismissible_timeline_follow_all", "app/data/welcome/second_session_follow", "app/ui/start/fixed_scroll_header", "app/data/select_all_scribe", "app/data/start/timeline_scribe", "app/ui/start/follow_all_button", "app/pages/start/find_friends", "app/data/start/follow_context_proxy", "app/pages/start/interests", "app/pages/start/first_tweet", "app/ui/start/select_interests", "app/pages/start/interest_list", "app/pages/start/congratulations_splash", ],
    "$bundle/timeline.df10962aaa8a993e7f703bf41db4dab87f135251.js" : ["app/data/tweet_actions", "app/utils/scale_animation_time", "app/ui/expando/with_expanding_containers", "app/ui/expando/expando_helpers", "app/ui/gallery/with_gallery", "app/ui/with_viewer_follow_state", "app/ui/tweets", "app/ui/tweet_injector", "app/ui/expando/with_expanding_social_activity", "app/ui/expando/with_expanding_conversations", "bower_components/xdm.js/xdm", "app/ui/with_card", "app/ui/expando/with_animated_gifs", "$lib/mediaelement.js", "app/ui/with_tweet_click_handler", "app/ui/with_tweet_activity_actions", "app/ui/expando/expanding_tweets", "app/ui/embed_stats", "app/ui/media/with_native_media", "app/ui/media/media_tweets", "app/utils/boomerang", "app/data/contact_import", "app/data/contact_import_scribe", "app/ui/dashboard_tweetbox", "app/utils/chrome", "app/utils/viewport_helpers", "app/ui/dynamic_card_watcher", "app/ui/who_to_follow/import_loading_dialog", "app/utils/oauth_popup", "app/ui/with_import_services", "app/ui/who_to_follow/import_services", "app/ui/events/matches", "app/ui/sms/mobile_download_prompt", "app/ui/profile/profile_preview_banner", "app/data/profile_preview_banner_scribe", "app/ui/profile_stats", "app/data/promptbird", "app/ui/select_all", "app/ui/who_to_follow/with_invite_messages", "app/ui/who_to_follow/with_invite_preview", "app/ui/who_to_follow/with_unmatched_contacts", "app/ui/dialogs/promptbird_invite_contacts_dialog", "app/data/promptbird_scribe", "app/ui/promptbird/with_invite_contacts", "app/ui/promptbird", "app/ui/profile/recent_connections_module", "app/data/trends", "app/data/trends/location_dialog", "app/data/trends/recent_locations", "app/utils/scribe_event_initiators", "app/data/trends_scribe", "app/ui/trends/with_share_trends", "app/ui/trends/trends", "app/ui/trends/trends_dialog", "app/ui/trends/dialog/with_location_info", "app/ui/trends/dialog/location_dropdown", "app/ui/trends/dialog/location_search", "app/ui/trends/dialog/current_location", "app/ui/trends/dialog/with_location_list_picker", "app/ui/trends/dialog/nearby_trends", "app/ui/trends/dialog/recent_trends", "app/ui/trends/dialog/dialog", "app/boot/trends", "app/ui/promptbird/tweet_prompt", "app/ui/infinite_scroll_watcher", "app/data/timeline", "app/boot/timeline", "app/data/activity_popup", "app/ui/dialogs/activity_popup", "app/data/activity_popup_scribe", "app/boot/activity_popup", "app/data/conversations", "app/data/curation", "app/data/media_settings", "app/data/media_tags", "app/ui/timelines/new_items_bar", "app/ui/dialogs/sensitive_flag_confirmation", "app/ui/media/sensitive_media_tweets", "app/data/tweet_activity_counts_scribe", "app/data/tweet_translation", "app/ui/user_actions", "app/ui/timelines/with_new_tweets_bar_experiment", "app/boot/tweets", "app/boot/help_pips_enable", "app/data/help_pips", "app/data/help_pips_scribe", "app/ui/help_pip", "app/ui/help_pips_injector", "app/boot/help_pips", "app/ui/expando/close_all_button", "app/ui/with_block_kb_shortcut_helpers", "app/ui/timelines/with_keyboard_navigation", "app/ui/with_focus_highlight", "app/ui/timelines/base_timeline", "app/ui/timelines/with_tweet_pagination", "app/ui/timelines/with_old_items", "app/ui/timelines/with_traveling_ptw", "app/ui/timelines/with_autoplaying_timeline", "app/ui/timelines/with_streaming_timeline", "app/ui/timelines/with_polling", "app/ui/timelines/with_new_items", "app/ui/timelines/with_activity_supplements", "app/ui/with_conversation_actions", "app/ui/timelines/with_pinned_stream_items", "app/ui/timelines/with_tweets_displayed_reporting", "app/ui/timelines/with_remove_user", "app/ui/timelines/tweet_timeline", "app/ui/with_timeline_tweet_actions_kb_shortcuts", "app/ui/timeline_tweet_actions", "app/ui/with_retweet_prevention", "app/ui/with_tweet_action_counts", "app/ui/with_dismiss_tweet", "app/ui/timelines/with_dismissible_promoted_tweets", "app/ui/timelines/with_min_max_pagination", "app/ui/timelines/min_max_tweet_timeline", "app/boot/tweet_timeline", "app/ui/timelines/tweet_visibility", "app/data/tweet_visibility_scribe", "app/ui/user_completion_module", "app/data/user_completion_module_scribe", "app/boot/user_completion_module", "app/ui/who_to_follow/with_import_prompt", "app/ui/who_to_follow/with_user_recommendations", "app/ui/who_to_follow/who_to_follow_dashboard", "app/data/who_to_follow", "app/data/who_to_follow_scribe", "app/ui/who_to_follow/who_to_follow_timeline", "app/data/who_to_follow/wtf_import_prompt_scribe", "app/pages/home", "app/boot/wtf_module", "app/data/who_to_tweet", "app/boot/connect", "app/ui/who_to_follow/with_list_resizing", "app/ui/who_to_follow/matched_contacts_list", "app/ui/who_to_follow/unmatched_contacts_list", "app/ui/who_to_tweet", "app/ui/who_to_follow/find_friends", "app/pages/connect/interactions", "app/pages/connect/mentions", "app/pages/connect/network_activity", "app/data/media_thumbnails_scribe", "app/ui/dialogs/iph_search_result_dialog", "app/ui/search_actions", "app/boot/search", "app/ui/timelines/with_story_pagination", "app/ui/gallery/with_grid", "app/ui/timelines/universal_timeline", "app/ui/with_gallery_scribe_data", "app/boot/universal_timeline", "app/ui/search/spelling_corrections", "app/ui/search/related_queries", "app/data/search_assistance_scribe", "app/pages/search/search", "app/ui/timelines/media_timeline", "app/boot/media_timeline", "app/pages/search/media", "app/ui/media/media_preview", "app/boot/preexpanded_cards", "app/ui/dropdown_toggle", "app/pages/explore/explore", "app/pages/explore/landing", "app/pages/simple_t1", "lib/hogan/template", "lib/mediaelement", ],
    "$bundle/permalink.5358f2b1acbc26beafb1e84b1c9bdaecda4384ec.js" : ["app/ui/permalink_keyboard_support", "app/ui/hidden_ancestors", "app/ui/hidden_descendants", "app/ui/dialogs/sms_codes", "app/ui/permalink_tweet", "app/ui/timelines/conversations/descendant_timeline", "app/ui/timelines/conversations/ancestor_timeline", "app/ui/related_tweets", "app/data/related_tweets", "app/ui/with_permalinktweet_tweet_actions", "app/ui/with_inline_reply", "app/data/embed_stats_scribe", "app/data/permalink_scribe", "app/pages/permalink", ],
    "$bundle/lists_permalink.d8fdaefdd2698f4453bd359cdea4bb99d062d528.js" : ["app/ui/list_members_dashboard", "app/data/list_members_dashboard", "app/ui/list_actions", "app/data/list_actions", "app/data/list_actions_scribe", "app/boot/list_permalink", "app/pages/list/permalink_tweets", "app/pages/list/permalink_users", ],
    "$bundle/buy_now.7fbec0ad48c0557aaaedad4756c4b6fbd156eacd.js" : ["app/ui/commerce/error_view", "app/ui/commerce/buy_now_view", "app/utils/credit_card_validator", "app/ui/commerce/payment_info_view", "app/ui/commerce/product_variant_selector", "app/ui/commerce/product_detail_view", "app/data/commerce/commerce", "app/pages/buy_now", "app/pages/buy_now_exception", ],
    "$bundle/discover.48cabf0de55634984486e575fe1a0c45b3c9bca0.js" : ["app/ui/discover_nav", "app/boot/discover", "app/ui/timelines/with_most_recent_story_pagination", "app/ui/timelines/discover_timeline", "app/boot/discover_timeline", "app/data/topic_pivots_scribe", "app/ui/with_topic_pivots", "app/ui/discover", "app/pages/discover/discover", "app/ui/people_search_input", "app/boot/who_to_follow", "app/utils/common_regexp", "app/ui/who_to_follow/invite_form", "app/ui/who_to_follow/pymk_kicker", "app/ui/who_to_follow/wipe_addressbook_dialog", "app/pages/who_to_follow/import", "app/pages/who_to_follow/interests", "app/pages/who_to_follow/invite", "app/pages/who_to_follow/lifeline", "app/pages/who_to_follow/matches", "app/pages/who_to_follow/suggestions", ],
    "$bundle/settings.3d18a8ca4d0c8b211887834c362f4d2d5a9d514f.js" : ["app/ui/alert_banner", "app/ui/forms/with_submit_disable", "app/ui/forms/form_value_modification", "app/boot/settings", "app/data/settings/account_scribe", "app/data/form_scribe", "app/ui/with_forgot_password", "app/ui/password_dialog", "app/ui/email_field_highlight", "app/ui/validating_fieldset", "app/ui/email_confirmation", "app/ui/settings/tweet_export", "app/ui/dialogs/tweet_export_dialog", "app/ui/timezone_detector", "app/ui/deactivated", "app/ui/settings_controls", "app/pages/settings/account", "app/data/settings/login_verification_test_run", "app/ui/settings/login_verification_sms_check", "app/ui/login_verification_confirmation_dialog", "app/ui/protected_verified_dialog", "app/ui/geo_deletion", "app/pages/settings/security", "app/data/settings/applications_scribe", "app/ui/oauth_revoker", "app/pages/settings/applications", "app/data/settings/confirm_deactivation_scribe", "app/pages/settings/confirm_deactivation", "app/ui/who_to_follow/wipe_addressbook_dialog", "app/utils/common_regexp", "app/ui/settings/invite_contact", "app/ui/settings/contacts_list_manager", "app/pages/settings/contacts_dashboard", "app/data/settings/design_scribe", "$lib/jquery_color_picker.js", "app/ui/color_picker", "app/ui/design", "app/ui/theme_preview", "app/utils/blend_hex_color", "app/ui/profile/override_user_css", "app/ui/theme_picker", "app/pages/settings/design", "app/pages/settings/email_follow", "app/pages/settings/favorite_people", "app/pages/settings/muted", "app/ui/settings/tweet_export_download", "app/pages/settings/tweet_export_download", "app/ui/settings/notifications", "app/ui/settings/notifications_global", "app/pages/settings/notifications", "app/ui/password", "app/ui/password_match_pair", "app/ui/with_password_strength", "app/ui/password_strength", "app/data/temporary_password", "app/ui/dialogs/temporary_password_dialog", "app/ui/temporary_password_button", "app/pages/settings/password", "app/ui/commerce/payment_profile_view", "app/utils/credit_card_validator", "app/data/commerce/commerce", "app/pages/settings/payments", "app/ui/profile_image_monitor", "app/boot/avatar_uploading", "app/data/settings/profile_scribe", "app/ui/settings/facebook_iframe_height_adjuster", "app/ui/field_edit_warning", "app/ui/dialogs/in_product_help_dialog", "app/boot/header_upload", "app/ui/settings/user_color_picker", "app/pages/settings/profile", "app/data/settings/facebook_proxy", "app/ui/settings/with_facebook_container", "app/ui/settings/facebook_spinner", "app/ui/settings/with_facebook_banner", "app/ui/settings/facebook_login", "app/ui/settings/facebook_connect", "app/ui/settings/facebook_missing_permissions", "app/ui/settings/facebook_mismatched_connection", "app/ui/settings/facebook_connection_conflict", "app/ui/settings/facebook_connected", "app/data/settings/facebook_scribe", "app/pages/settings/facebook", "app/data/settings/sms_scribe", "app/ui/settings/sms_phone_create_form", "app/ui/forms/element_group_toggler", "app/ui/settings/device_verified_form", "app/ui/settings/sms_phone_verify_form", "app/pages/settings/sms", "app/ui/settings/device_registration_form", "app/data/settings/device_registration_form_scribe", "app/pages/settings/device_registration", "app/ui/settings/web_notifications_request", "app/data/settings/web_notifications_submit", "app/pages/settings/web_notifications", "app/pages/settings/safety", "app/ui/settings/widgets", "app/pages/settings/widgets", "app/ui/settings/widgets_configurator", "app/pages/settings/widgets_configurator", ],
    ...
    "$bundle/events.35a1bd881fa9e62ec9c797b7f9ca9e6cb5df509a.js" : ["app/ui/media/media_thumbnails", "app/ui/timelines/event_timeline", "app/data/page_visibility_scribe", "app/pages/events/hashtag", ],
    "$bundle/accounts.51af2832d5261a167ee759ab2ae5a07a9bf947f6.js" : ["app/ui/account/password_reset_controls", "app/ui/password_match_pair", "app/ui/with_password_strength", "app/ui/password_strength", "app/pages/account/password_reset", "app/ui/captcha_dialog", "app/ui/account/resend_password_controls", "app/ui/validating_fieldset", "app/data/resend_password", "app/pages/account/resend_password", "app/ui/account/verify_personal_information_controls", "app/pages/account/verify_personal_information", "app/ui/account/verify_device_token_controls", "app/pages/account/verify_device_token", "app/ui/account/resend_password_help_controls", "app/data/resend_password_help", "app/data/resend_password_help_scribe", "app/pages/account/resend_password_help", "app/pages/account/errors", ],
    "$bundle/search.3f5b5bf0a6a922efa7ee8508b574228d83632e9d.js" : ["app/ui/dialogs/search_operators_dialog", "app/pages/search/home", "$lib/bootstrap_datepicker.js", "app/ui/with_bootstrap_datepicker", "app/ui/advanced_search", "app/pages/search/advanced", ],
    "$bundle/vitonboarding.7430a6a5a850cccf4a14564f8e0f0622a998d2e6.js" : ["$lib/jquery.hashchange.js", "app/ui/vit/verification_step", "app/ui/vit/mobile_topbar", "app/pages/vit/onboarding", ],
    "$bundle/profile_alerts.4cf72851df105dc8ae12792aa7bcc4dc0ead3484.js" : ["app/ui/with_redirect_after_follow", "app/ui/profile/lifeline_follow", "app/data/profile_alerts_scribe", "app/pages/profile/alerts", ],
  ...
  define("bower_components/flight/lib/debug", [], (function () 
  {
    function a(b, d, e) 
    {
      e = e || {
      ...
      var f = e.obj || window, g = e.path || (f == window ? "window" : ""), 
      h = Object.keys(f);
      h.forEach((function (e) 
      {
        (c[b] || b)(d, f, e) && console.log([g, ".", e, ].join(""), "->", ["(", typeof f[e], ")", ].join(""), 
        f[e]), 
        Object.prototype.toString.call(f[e]) == "[object Object]" && f[e] != f && g.split(".").indexOf(e) == - 1 && a(b, d, {
          obj : f[e],
          path : [g, e, ].join(".")
        });
      }));
    ...
    function b(b, c, d, e) 
    {
      ! c || typeof d == c ? a(b, d, e) : console.error([d, "must be", c, ].join(" "));
    }
    function d(a, c) 
    {
      b("name", "string", a, c);
    ...
    function l() 
    {
      ...
      k.eventNames.length || (k.eventNames = j), k.actions = a.length ? a : j, 
      p();
    }
    function m() 
    {
      var a = [].slice.call(arguments);
      k.actions.length || (k.actions = j), k.eventNames = a.length ? a : j, 
      p();
    }
    function n() 
    {
      k.actions = [], k.eventNames = [], p();
    }
    function o() 
    {
      k.actions = j, k.eventNames = j, p();
    }
    function p() 
    {
      try
{        window.localStorage && (localStorage.setItem("logFilter_eventNames", k.eventNames), 
        localStorage.setItem("logFilter_actions", k.actions));}
      catch(a)
{        }
    ...
    function q() 
    {
      var a, b;
      try
{        a = window.localStorage && localStorage.getItem("logFilter_eventNames"), 
        b = window.localStorage && localStorage.getItem("logFilter_actions");}
      catch(c)
{        return;}

      a && (k.eventNames = a), b && (k.actions = b), Object.keys(k).forEach((function (a) 
      {
        var b = k[a];
        typeof b == "string" && b !== j && (k[a] = b ? b.split(",") : []);
      }));
    }
    "use strict";
    var c = {
    ...
    return {
      enable : (function (a) 
      {
        this.enabled = ! ! a, a && window.console && (console.info("Booting in DEBUG mode"), console.info("You can configure event logging with DEBUG.events.logAll()/logNone()/logByName()/logByAction()")), 
        q(), 
        window.DEBUG = this;
      }),
      find : {
  ...
  define("bower_components/flight/lib/utils", ["./debug", ], (function (a) 
  {
    function d() 
    {
      var b = a.enabled && ! e.isEnumerable(Object, "getOwnPropertyDescriptor");
      if(b)
        try
...
{          return ! 1;}
    ...
    var b = [], c = 100, e = {
      ...
      merge : (function () 
      {
        ...
        }, c[c.length - 1] === ! 0 && (c.pop(), c.unshift(! 0)), 
        $.extend.apply(undefined, c));
      }),
      push : (function (a, b, c) 
      {
      ...
      debounce : (function (a, b, d) 
      {
        ...
        return (function () 
        {
          var c = this, g = arguments, h = (function () 
          {
            e = null, d || (f = a.apply(c, g));
          }), 
          i = d && ! e;
          return clearTimeout(e), e = setTimeout(h, b), i && (f = a.apply(c, g)), 
          f;
        });
      }),
      throttle : (function (a, b) 
      {
        ...
        return (function () 
        {
          ...
          return f || (f = setTimeout(c, b)), g ? h = ! 0 : (g = ! 0, i = a.apply(d, e)), 
          j(), 
          i;
        });
      }),
      ...
      propertyWritability : (function (a, b, c) 
      {
        d() && a.hasOwnProperty(b) && Object.defineProperty(a, b, {
          writable : c
        });
      }),
      mutateProperty : (function (a, b, c) 
      {
        var e;
  ...
  define("bower_components/flight/lib/compose", ["./utils", ], 
  (function (a) 
  {
    function c(c, d) 
    {
  ...
  define("bower_components/flight/lib/advice", ["./compose", "./utils", ], 
  (function (a, b) 
  {
  "use strict";
    var c = {
      ...
      withAdvice : (function () 
      {
        ["before", "after", "around", ].forEach((function (a) 
        {
          this[a] = (function (d, e) 
          {
            b.mutateProperty(this, d, (function () 
            {
  ...
  define("bower_components/flight/lib/registry", [], (function () 
  {
    function a(a, b) 
    {
      ...
      return typeof b[f - 1] == "function" && (f -= 1, e = b[f]), 
      typeof b[f - 1] == "object" && (f -= 1), 
      f == 2 ? (c = b[0], d = b[1]) : (c = a.node, d = b[0]), 
      {
        element : c,
        type : d,
        callback : e
    ...
    function c() 
    {
      function d(a) 
      {
        this.component = a, this.attachedTo = [], this.instances = {
          
        }, 
        this.addInstance = (function (a) 
        {
          var b = new e(a);
          return this.instances[a.identity] = b, this.attachedTo.push(a.node), 
          b;
        }), 
      ...
      this.on = (function (b) 
      {
        var d = c.findInstanceInfo(this), e, f = arguments.length, 
        g = 1, 
        h = new Array(f - 1);
        for(;g < f;g ++)
          h[g - 1] = arguments[g];
      ...
      this.withRegistration = (function () 
      {
        ...
        this.around("on", c.on), 
        this.after("off", c.off), 
        window.DEBUG && DEBUG.enabled && this.after("trigger", c.trigger), 
        this.after("teardown", {
          obj : c,
          fnName : "teardown"
        });
  ...
  define("bower_components/flight/lib/base", ["./utils", "./registry", "./debug", ], 
  (function (a, b, c) 
  {
    function e(a) 
    {
      ...
      {
        var b = [a.type, ];
        a.element && b.unshift(a.element), typeof a.callback == "function" && b.push(a.callback), 
        this.off.apply(this, b);
      }), 
      a.instance);
    }
    function f(a, b) 
...
{        throw console.log("unserializable data for event", a, ":", b), 
        new Error(["The event", a, "on component", this.toString(), "was triggered with non-serializable data", ].join(" "));}
    ...
    function j() 
    {
      this.trigger = (function () 
      {
        ...
        return typeof i != "string" && (! i || ! i.defaultBehavior) && (h --, d = i), 
        h == 1 ? (a = $(arguments[0]), e = arguments[1]) : (a = this.$node, e = arguments[0]), 
        e.defaultBehavior && (g = e.defaultBehavior, e = $.Event(e.type)), 
        b = e.type || e, 
        c.enabled && window.postMessage && f.call(this, b, d), 
        typeof this.attr.eventData == "object" && (d = $.extend(! 0, {
          
        }, this.attr.eventData, d)), 
        a.trigger(e || b, d), 
        g && ! e.isDefaultPrevented() && (this[g] || g).call(this), 
        a;
      }), 
      this.on = (function () 
      {
        var b, c, d, e, f = arguments.length - 1, g = arguments[f];
        typeof g == "object" ? e = a.delegate(this.resolveDelegateRules(g)) : typeof g == "string" ? e = i(g) : e = g, 
        f == 2 ? (b = $(arguments[0]), c = arguments[1]) : (b = this.$node, c = arguments[0]);
        if(typeof e != "function" && typeof e != "object")
          throw new Error('Unable to bind to "' + c + '" because the given callback is not a function or an object');
        return d = e.bind(this), d.target = e, d.context = this, b.on(c, d), 
        e.bound || (e.bound = []), 
        e.bound.push(d), 
        d;
      }), 
      this.off = (function () 
      {
        ...
        typeof arguments[d] == "function" && (c = arguments[d], d -= 1), 
        d == 1 ? (a = $(arguments[0]), b = arguments[1]) : (a = this.$node, b = arguments[0]);
        if(c)
        {
          var e = c.target ? c.target.bound : c.bound || [];
          e && e.some((function (a, b, d) 
          {
            if(a.context && this.identity == a.context.identity)
              return d.splice(b, 1), c = a, ! 0;
          }), 
          this);
        }
        return a.off(b, c);
      ...
      this.initialize = (function (a, b) 
      {
        ...
        return a.jquery ? (this.node = a[0], this.$node = a) : (this.node = a, this.$node = $(a)), 
        this.attrDef ? g.call(this, b) : h.call(this, b), 
        this;
      }), 
      this.teardown = (function () 
      {
  ...
  define("bower_components/flight/lib/logger", ["./utils", ], 
  (function (a) 
  {
    function c(a) 
    {
      var b = a.tagName ? a.tagName.toLowerCase() : a.toString(), 
    ...
    function d(a, d, e) 
    {
      ...
      typeof e[e.length - 1] == "function" && (i = e.pop(), i = i.unbound || i), 
      e.length == 1 ? (h = d.$node[0], g = e[0]) : e.length == 2 && typeof e[1] == "object" && ! e[1].type ? (h = d.$node[0], g = e[0], a == "trigger" && (j = e[1])) : (h = e[0], g = e[1], a == "trigger" && (j = e[2])), 
      f = typeof g == "object" ? g.type : g, 
      k = DEBUG.events.logFilter, 
      m = k.actions == "all" || k.actions.indexOf(a) > - 1, 
      l = (function (a) 
      {
      ...
      m && n && (o = [b[a], a, "[" + f + "]", ], j && o.push(j), o.push(c(h)), 
      o.push(d.constructor.describe.split(" ").slice(0, 3).join(" ")), 
      console.groupCollapsed && a == "trigger" && console.groupCollapsed(a, f), 
  ...
  define("bower_components/flight/lib/component", ["./advice", "./utils", "./compose", "./base", "./registry", "./logger", "./debug", ], 
...
{        throw console.log("unserializable data for event", a, ":", b), 
    ...
    function m() 
    {
      var h = arguments.length, j = new Array(h);
      for(var n = 0;n < h;n ++)
        j[n] = arguments[n];
      var o = (function () 
      {
      ...
      return o.toString = o.prototype.toString = l, g.enabled && (o.describe = o.prototype.describe = o.toString()), 
      o.attachTo = k, 
      o.mixin = (function () 
      {
        var a = m(), d = Object.create(o.prototype);
        return d.mixedIn = [].concat(o.prototype.mixedIn), d.defaults = b.merge(o.prototype.defaults), 
        c.mixin(d, arguments), 
        a.prototype = d, 
      ...
      o.teardownAll = i, 
      g.enabled && j.unshift(f), 
      j.unshift(d, a.withAdvice, e.withRegistration), 
      c.mixin(o.prototype, j), 
      o;
    }
    "use strict";
    var h = /function (.*?)\s?\(/;
    return m.teardownAll = (function () 
    {
  ...
  define("core/component", ["module", "require", "exports", "bower_components/flight/lib/component", ], 
  (function (module, require, exports) 
  {
    module.exports = require("bower_components/flight/lib/component");
  }));
  define("core/registry", ["module", "require", "exports", "bower_components/flight/lib/registry", ], 
  (function (module, require, exports) 
  {
    module.exports = require("bower_components/flight/lib/registry");
  }));
  define("core/clock", ["module", "require", "exports", "core/component", "core/registry", ], 
  (function (module, require, exports) 
  {
    ...
    {
      this.countdown = this.interval = this.maxInterval = this.initialInterval = b, 
      this.backoffFactor = BACKOFF_FACTOR, 
      this.eventName = a, 
      this.data = c;
    }
    var defineComponent = require("core/component"), registry = require("core/registry"), 
    ClockComponent = defineComponent(clockComponent), 
    myClock = new Clock, 
    INTERVAL = 500, 
    BACKOFF_FACTOR = 2;
    ...
    var Interval = (function () 
    {
      ...
      {
        this.maxInterval = a, this.backoffFactor = b || BACKOFF_FACTOR, 
        this.interval > this.maxInterval && (this.interval = a);
      }), 
  ...
  define("core/compose", ["module", "require", "exports", "bower_components/flight/lib/compose", ], 
  (function (module, require, exports) 
  {
    module.exports = require("bower_components/flight/lib/compose");
  }));
  define("core/advice", ["module", "require", "exports", "bower_components/flight/lib/advice", ], 
  (function (module, require, exports) 
  {
    module.exports = require("bower_components/flight/lib/advice");
  }));
  define("core/parameterize", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    var tokenizerRE = /\{\{(.+?)\}\}/g;
  ...
  define("core/i18n", ["module", "require", "exports", "core/parameterize", ], 
  (function (module, require, exports) 
  {
    module.exports = require("core/parameterize");
  }));
  define("core/logger", ["module", "require", "exports", "bower_components/flight/lib/logger", ], 
  (function (module, require, exports) 
  {
    module.exports = require("bower_components/flight/lib/logger");
  }));
  define("core/utils", ["module", "require", "exports", "bower_components/flight/lib/utils", ], 
  (function (module, require, exports) 
  {
    module.exports = require("bower_components/flight/lib/utils");
  }));
  define("debug/debug", ["module", "require", "exports", "bower_components/flight/lib/debug", ], 
  (function (module, require, exports) 
  {
    var flightDebug = require("bower_components/flight/lib/debug");
    module.exports = flightDebug;
  }));
  define("app/utils/auth_token", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    var authToken;
    module.exports = {
      ...
      addTo : (function (a, b) 
      {
        return a.authenticity_token = authToken, b && (a.post_authenticity_token = authToken), 
        a;
      })
    };
  }));
  define("app/data/scribe_transport", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    function ScribeTransport(a) 
    {
      this.SESSION_BUFFER_KEY = "ScribeTransport", this.SCRIBE_API_ENDPOINT = "/i/jot", 
      this.options = {
    ...
    ScribeTransport.prototype = {
      flush : (function (a, b) 
      {
        ...
        if(this.options.useAjax)
        {
          ...
          this.options.debug && (this.options.debugHandler && (c.success = this.options.debugHandler), 
          c.data.debug = "1"), 
          $.ajax(c);
        }
        else
...
{          if(c.name !== "QuotaExceededError" && c.message !== "QuotaExceededError" && c.name !== "NS_ERROR_DOM_QUOTA_REACHED" && c.name !== "QUOTA_EXCEEDED_ERR" && c.number !== - 2147024882)
      ...
      encodeEventData : (function (a) 
      {
        ...
        return this.options.useAjax || (b = encodeURIComponent(b)), 
        b;
      }),
      ...
      send : (function (a, b, c) 
      {
        if(! b || ! a || this.options.bufferSize < 0)
          return;
        this.addCategoryField(a, b), c || ! this.options.bufferEvents || ! this.options.bufferSize ? this.flush([a, ], c) : this.addToBuffer(a), 
        this.options.debug && $(document).trigger("scribedata." + this.options.bufferKey, a), 
        this.options.metrics && a.event_info != "debug" && $(document).trigger("debugscribe", a);
      }),
      ...
      updateOptions : (function (a) 
      {
        ...
        this.options.flushOnUnload === undefined && (this.options.flushOnUnload = ! 0), 
        this.options.bufferKey || (this.options.bufferKey = this.SESSION_BUFFER_KEY), 
        this.options.bufferSize === 0 && (this.options.bufferEvents = ! 1), 
        this.options.useAjax === undefined && (this.options.useAjax = ! 0);
...
{            this.options.bufferEvents = ! 1;}
        ...
        this.options.url === undefined ? this.options.useAjax ? this.options.url = this.SCRIBE_API_ENDPOINT : this.options.url = "https://twitter.com" + this.SCRIBE_API_ENDPOINT : this.options.url = this.options.url.replace(/^[a-z]+:/g, e).replace(/\/$/, ""), 
        this.options.bufferEvents && this.options.bufferSize === undefined && (this.options.bufferSize = 20);
      }),
      appHost : (function () 
      {
      ...
      registerEventHandlers : (function () 
      {
        ...
        if(this.options.bufferEvents)
        {
          ...
          if(this.options.flushOnUnload)
          {
            var c = (function (b) 
            {
              a.skipUnloadFlush = ! b || ! b.match(/http/) || ! ! b.match(new RegExp("^https?://" + a.appHost(), "gi")), 
              a.skipUnloadFlush && window.setTimeout((function () 
              {
                a.skipUnloadFlush = ! 1;
              }), 
              3000);
      ...
      destroy : (function () 
      {
        this.flush(this.getBuffer()), $(document).off("flushscribe." + this.options.bufferKey), 
  ...
  define("app/data/scribe_monitor", ["module", "require", "exports", "core/component", ], 
  (function (module, require, exports) 
  {
...
{            var d = "ScribeMonitor.postToConsole - Scribe Console error or unserializable data [" + a._category_ + "]";
      ...
      this.after("initialize", (function () 
      {
        this.on("keypress", (function (a) 
        {
          ...
          {
            var b = "menubar=no,toolbar=no,personalbar=no,location=no,resizable=yes,status=no,dependent=yes,height=600,width=600,screenX=100,screenY=100,scrollbars=yes", 
            c = window.location.host;
            this.verifyHost(c) || (c = "twitter.com"), window.scribeConsole = window.open(window.location.protocol + "//" + c + "/scribe/console", 
            "scribe_console", 
            b);
          }
        })), 
        this.on("scribedata.ScribeTransport handlescribe.ScribeTransport", 
        (function (b, c) 
        {
          a(c);
        })), 
  ...
  define("app/data/client_event", ["module", "require", "exports", "app/data/scribe_transport", ], 
  (function (module, require, exports) 
  {
    function ClientEvent(a) 
    {
      ...
      this.scribe = (function (b, c) 
      {
        ...
        c.event_namespace = b, c.triggered_on = c.triggered_on || + (new Date), 
        c.format_version = c.format_version || 2, 
        d.send(c, "client_event");
      });
    }
    var scribeTransport = require("app/data/scribe_transport");
    module.exports = new ClientEvent(scribeTransport);
  }));
  define("app/utils/scribe_association_types", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    module.exports = {
      associatedTweet : 1,
  ...
  define("app/data/with_scribe", ["module", "require", "exports", "app/data/client_event", "core/utils", ], 
  (function (module, require, exports) 
  {
    function withScribe() 
    {
      ...
      {
        var b = Array.prototype.slice.call(arguments), c, d, e, f, 
        g;
        c = typeof b[0] == "string" ? {
          action : b[0]
        } : b[0], 
        ...
        }, f, c), d = typeof b[0] == "function" ? b[0].bind(this)(e) : b[0], 
        d = utils.merge({
  ...
  define("app/utils/with_session", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/utils/scribe_item_types", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    module.exports = {
      tweet : 0,
  ...
  define("app/data/with_interaction_data_scribe", ["module", "require", "exports", "core/compose", "app/data/with_scribe", "app/utils/with_session", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/client_event", "core/utils", ], 
  (function (module, require, exports) 
  {
    function withInteractionDataScribe() 
    {
      ...
      compose.mixin(this, [withScribe, withSession, ]), 
      this.scribeInteraction = (function (a, b, c) 
      {
        if(! a || ! b)
          return;
        typeof a == "string" && (a = {
        ...
        b.url && (e.url = b.url), b.query && (e.query = b.query), 
        b.impressionId && (e.promoted = ! 0);
        var f = this.interactionItem(b);
        f && (e.items = [f, ]);
        var g = this.interactionTarget(b, a);
        g && (e.targets = [g, ]), c = utils.merge(e, c, b.scribeData), 
        b.conversationOriginTweetId && (c.associations = c.associations || {
      ...
      this.interactionItem = (function (a) 
      {
        ...
        switch(a.itemType){
          ...
          case "tweet":
            this.tweetDetails(b, a), this.cardDetails(b, a), this.translationDetails(b, a), 
            this.conversationDetails(b, a), 
            this.lingerDetails(b, a);
            break;
      ...
      {
        return a.id = b.tweetId, a.item_type = itemTypes.tweet, b.relevanceType && (a.is_popular_tweet = ! 0), 
        b.retweetId && (a.retweeting_tweet_id = b.retweetId), 
        a;
      }), 
      ...
      {
        b.visibility_start && (a.visibility_start = b.visibility_start), 
        b.visibility_end && (a.visibility_end = b.visibility_end);
      }), 
      this.userDetails = (function (a, b) 
      {
        return a.id = b.containerUserId || b.userId, a.item_type = itemTypes.user, 
        b.feedbackToken && (a.token = b.feedbackToken), 
        a;
      }), 
      ...
      {
        return a.activity_type = b.activityType, b.actingUserIds && (a.acting_user_ids = b.actingUserIds), 
        a;
      }), 
      this.storyDetails = (function (a, b) 
      {
        return a.story_type = b.storyType, a.story_source = b.storySource, 
        a.social_proof_type = b.socialProofType, 
        a;
      }), 
      ...
      {
        return a.action == "profile_click" && a.element === undefined && (a.element = b.isPromotedBadgeClick ? "promoted_badge" : b.profileClickTarget), 
        a;
      }), 
      this.scribeInteractiveResults = (function (a, b, c, d) 
      {
        ...
        a = this.getInteractionScribeContext(a, c);
        var g = {
          
        };
        e && e.length && (g.items = e), f && (g.promoted = ! 0), 
        this.scribe(a, c, utils.merge(g, d));
      }), 
      this.associationNamespace = (function (a, b) 
      {
        ...
        return ["conversation", "replies", "in_reply_to", ].indexOf(b) >= 0 && (c.component = b), 
        c;
      }), 
      this.getProfileUserAssociations = (function () 
      {
        var a = this.attr.profile_user && this.attr.profile_user.id_str, 
        b = null;
        return a && (b = {
      ...
      this.saveProfileClickContext = (function (a) 
      {
        ...
        a.conversationOriginTweetId && (b[associationTypes.conversationOrigin] = {
          ...
          association_type : itemTypes.tweet
        })) : b = this.getProfileUserAssociations(), 
      ...
      this.getUserActionAssociations = (function (a) 
      {
        ...
        return b == "profile_dialog" || b == "profile_follow_card" ? c = this.getProfileClickContextAssociations(a.userId) : b == "user" ? c = this.getProfileUserAssociations() : c = null, 
        c;
      });
    }
    var compose = require("core/compose"), withScribe = require("app/data/with_scribe"), 
    withSession = require("app/utils/with_session"), 
    itemTypes = require("app/utils/scribe_item_types"), 
    associationTypes = require("app/utils/scribe_association_types"), 
    clientEvent = require("app/data/client_event"), 
    utils = require("core/utils");
    module.exports = withInteractionDataScribe;
  }));
  define("app/utils/scribe_card_types", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    module.exports = {
      photoTweet : 1,
  ...
  define("app/data/with_card_metadata", ["module", "require", "exports", "core/compose", "core/utils", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe", "app/utils/scribe_item_types", "app/utils/scribe_card_types", ], 
  (function (module, require, exports) 
  {
    function withCardMetadata() 
    {
      ...
      this.getCardDataFromTweet = (function (a) 
      {
        ...
        }, c = a.closest("[data-tweet-id]"), 
        d, 
        e, 
        f, 
        g, 
        h;
        return ! c.find(".card2").length && ! c.find(".cards-base").length ? d = $(c.attr("data-expanded-footer")) : d = c, 
        b.tweetHasCard = c.hasClass("has-cards"), 
        g = ! ! d.find(".card2").length, 
        b.interactionInsideCard = ! 1, 
        g ? (b.tweetHasCard2 = g, b.tweetPreExpanded = c.hasClass("preexpanded"), 
        b.itemId = c.attr("data-item-id") || null, 
        b.promotedId = c.attr("data-impression-id") || null, 
        f = d.find(".card2"), 
        h = f.find(".js-macaw-cards-iframe-container"), 
        h.length ? (b.cardName = h.attr("data-card-name"), b.cardUrl = h.attr("data-card-url"), 
        b.publisherUserId = h.attr("data-publisher-id"), 
        b.creatorUserId = h.attr("data-creator-id"), 
        b.amplifyContentId = h.attr("data-amplify-content-id") || null, 
        b.amplifyPlaylistUrl = h.attr("data-amplify-playlist-url") || null) : (b.cardName = f.attr("data-card2-name"), b.cardUrl = f.find(".card2-holder").attr("data-card2-url"), 
        b.publisherUserId = this.getUserIdFromElement(f.find(".card2-attribution").find(".js-user-profile-link")), 
        b.creatorUserId = this.getUserIdFromElement(f.find(".card2-byline").find(".js-user-profile-link"))), 
        b.interactionInsideCard = ! ! a.closest(".card2").length) : b.tweetHasCard && (e = d.find(".cards-base"), e.length > 0 && (b.cardType = e.data("card-type"), b.cardUrl = e.data("card-url"), 
        b.publisherUserId = this.getUserIdFromElement(e.find(".source .js-user-profile-link")), 
        b.creatorUserId = this.getUserIdFromElement(e.find(".byline .js-user-profile-link")), 
        b.interactionInsideCard = this.interactionInsideCard(a))), 
        b;
      }), 
      ...
      this.scribeCard2Interaction = (function (a, c, d, e) 
      {
        ...
        typeof e == "object" && e && (f = utils.merge(f, e)), 
        g = {
          items : [f, ]
        }, 
        this.scribeInteraction({
    ...
    var compose = require("core/compose"), utils = require("core/utils"), 
    associationTypes = require("app/utils/scribe_association_types"), 
    withInteractionDataScribe = require("app/data/with_interaction_data_scribe"), 
    itemTypes = require("app/utils/scribe_item_types"), 
    cardTypes = require("app/utils/scribe_card_types");
    module.exports = withCardMetadata;
  }));
  define("app/data/with_conversation_metadata", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    module.exports = (function () 
    {
      ...
      this.extraInteractionData = (function (a) 
      {
        if(a.find(this.attr.conversationModuleSelector).length > 0)
        {
          ...
          c = a.find(this.attr.conversationAncestorTweetSelector).map((function (a, b) 
          {
      ...
      {
        return b && b.isConversation ? (a.component = "conversation", a.element = "tweet") : b && b.isConversationComponent && (a.component = "conversation", c || (a.element = b.description)), 
        a;
      }), 
      this.after("initialize", (function () 
      {
        this.attr.conversationModuleSelector || (this.attr.conversationModuleSelector = this.attr.conversationModuleSelectorAlt), 
        this.attr.hasConversationModuleClass || (this.attr.hasConversationModuleClass = this.attr.hasConversationModuleClassAlt);
      }));
    });
  }));
  define("app/ui/with_interaction_data", ["module", "require", "exports", "core/compose", "core/utils", "app/data/with_card_metadata", "app/data/with_conversation_metadata", ], 
  (function (module, require, exports) 
  {
    function withInteractionData() 
    {
      compose.mixin(this, [withCardMetadata, withConversationMetadata, ]), 
      this.defaultAttrs({
      ...
      {
        var b, c = - 1, d = a.closest(this.attr.expandoAncestorSelector), 
        e = a.closest(this.attr.expandoDescendantSelector);
        return d.length && (b = d.closest(this.attr.expandoContainerSelector), c = b.find(this.attr.expandoAncestorSelector).index(d)), 
        e.length && (b = e.closest(this.attr.expandoContainerSelector), c = b.find(this.attr.expandoDescendantSelector).index(e)), 
        a.closest(".in-reply-to,.replies-to").length && (b = a.closest(".in-reply-to,.replies-to"), c = b.find(".tweet").index(a.closest(".tweet"))), 
        c;
      }), 
      ...
      this.getEventData = (function (c, d) 
      {
        ...
        switch(this.attr.itemType){
          ...
          case "tweet":
            return g = utils.merge(this.getDataAttrs(c, b), this.getConversationAttrs(c)), 
            d ? utils.merge(this.getCardAttrs(c), g) : g;
      ...
      this.getActivityEventData = (function (a) 
      {
        ...
        e.isNetworkActivity = ! ! a.closest(".discover-stream").length, 
        e.activityType || (e.isReplyTo ? e.activityType = "reply" : e.activityType = e.retweetId ? "retweet" : "mention");
      ...
      this.getDataAttrs = (function (a, b, c) 
      {
        ...
        return e && (d.targetUserId = e), d.userId = a.closest("[data-user-id]").attr("data-user-id"), 
        d.containerUserId = c.closest("[data-user-id]").attr("data-user-id"), 
        d;
      }), 
      ...
      this.getEmailFollowSettingsAttrs = (function (a) 
      {
        return this.getDataAttrs(a, f);
      });
    }
    var compose = require("core/compose"), utils = require("core/utils"), 
    withCardMetadata = require("app/data/with_card_metadata"), 
    withConversationMetadata = require("app/data/with_conversation_metadata");
    module.exports = withInteractionData;
  }));
  define("app/data/tweet_actions_scribe", ["module", "require", "exports", "core/component", "core/utils", "app/ui/with_interaction_data", "app/data/with_conversation_metadata", "app/data/with_interaction_data_scribe", ], 
  (function (module, require, exports) 
  {
    function tweetActionsScribe() 
    {
      ...
      this.after("initialize", (function () 
      {
        this.on("uiReplyButtonTweetSuccess", this.scribeTweet("reply")), 
        this.on("uiDidRetweetSuccess", this.scribeTweet("retweet")), 
        this.on("uiDidDeleteTweet", this.scribeTweet("delete")), 
        this.on("dataDidFavoriteTweet", this.scribeTweet("favorite")), 
        this.on("dataDidUnfavoriteTweet", this.scribeTweet("unfavorite")), 
        this.on("dataDidUnretweet", this.scribeTweet("unretweet")), 
        this.on("uiPermalinkClick", this.scribeTweet("permalink")), 
        this.on("uiDidShareViaEmailSuccess", this.scribeTweet("share_via_email")), 
        this.on("dataTweetTranslationSuccess", this.scribeTweet("translate")), 
        this.on("dataDidUserPinTweet", this.scribeTweet("pin")), 
        this.on("dataDidUserUnpinTweet", this.scribeTweet("unpin")), 
  ...
  define("app/data/block_or_report_scribe", ["module", "require", "exports", "core/component", "core/utils", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe", ], 
  (function (module, require, exports) 
  {
    function blockOrReportScribe() 
    {
      ...
      this.after("initialize", (function () 
      {
        this.on(document, "uiNeedsBlockOrReportDialog", this.blockOrReportImpression), 
        this.on(document, "uiDidBlockOrReport uiReportUserAction", this.blockOrReportSubmit), 
        this.on(document, "uiDidBlockOrReportToSupport", this.blockOrReportAbuseToSupport), 
        this.on(document, "uiDidCancelBlockOrReport", this.cancelBlockOrReport), 
  ...
  define("app/data/user_actions_scribe", ["module", "require", "exports", "core/component", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe", ], 
  (function (module, require, exports) 
  {
    function userActionsScribe() 
    {
      ...
      this.defaultAttrs({
        ...
        userActionToActionMap : {
          ...
          uiFavoriteUserAction : {
            element : "favorite_people",
            action : "favorite_user"
          },
          uiUnfavoriteUserAction : {
            element : "favorite_people",
            action : "unfavorite_user"
          },
      ...
      this.handleUserEvent = (function (b, c) 
      {
        ...
        c.isFollowBack && this.scribeInteraction("follow_back", c, a(c.sourceEventData));
      }), 
      ...
      this.after("initialize", (function () 
      {
        this.on(document, "dataFollowStateChange dataUserActionSuccess dataEmailFollow dataEmailUnfollow", 
        this.handleUserEvent), 
        this.on(document, "uiMentionAction uiReportSpamAction uiListAction uiDmAction uiRetweetOnAction uiRetweetOffAction uiDeviceNotificationsOnAction uiDeviceNotificationsOffAction uiShowMobileNotificationsConfirm uiShowPushTweetsNotificationsConfirm uiEmailFollowAction uiEmailUnfollowAction uiFavoriteUserAction uiUnfavoriteUserAction uiUserTopicClickAction uiMuteUserAction uiUnmuteUserAction uiLoggedOutFollowAttempt", 
        this.handleAction);
      }));
    }
    var defineComponent = require("core/component"), itemTypes = require("app/utils/scribe_item_types"), 
    associationTypes = require("app/utils/scribe_association_types"), 
    withInteractionDataScribe = require("app/data/with_interaction_data_scribe");
    module.exports = defineComponent(userActionsScribe, withInteractionDataScribe);
  }));
  define("app/data/item_actions_scribe", ["module", "require", "exports", "core/component", "app/data/with_interaction_data_scribe", "app/data/with_conversation_metadata", "app/data/with_card_metadata", ], 
  (function (module, require, exports) 
  {
    function itemActionsScribe() 
    {
      ...
      this.scribeLinkClick = (function (a, b) 
      {
        ...
        b.tcoUrl && (c.message = b.tcoUrl), b.text && b.text.indexOf("pic.twitter.com") == 0 && (b.url = "http://" + b.text), 
        this.scribeInteraction("open_link", b, c);
      }), 
      ...
      this.after("initialize", (function () 
      {
        ...
        this.on(document, "uiUserFollowTweetInjection", this.handleUserFollowTweetInjection), 
        this.attr.profileHoversEnabled || this.on(document, "dataProfilePopupSuccess", this.handleProfilePopup), 
        this.on(document, "uiItemSelected", this.scribeItemAction.bind(this, "select")), 
        this.on(document, "uiItemDeselected", this.scribeItemAction.bind(this, "deselect")), 
        ...
        this.on(document, "uiItemDeselected", this.scribeCardAction.bind(this, "hide")), 
    ...
    var defineComponent = require("core/component"), withInteractionDataScribe = require("app/data/with_interaction_data_scribe"), 
    withConversationMetadata = require("app/data/with_conversation_metadata"), 
    withCardMetadata = require("app/data/with_card_metadata");
    module.exports = defineComponent(itemActionsScribe, withInteractionDataScribe, withConversationMetadata, 
    withCardMetadata);
  }));
  define("app/utils/full_path", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    function fullPath() 
    {
  ...
  define("app/data/navigation_scribe", ["module", "require", "exports", "core/component", "app/data/client_event", "app/data/with_scribe", "app/utils/full_path", ], 
  (function (module, require, exports) 
  {
    function navigationScribe() 
    {
      ...
      this.after("initialize", (function () 
      {
        clientEvent.internalReferer = fullPath(), this.on("uiNavigationLinkClick", this.scribeNav), 
  ...
  define("app/data/update_scribe", ["module", "require", "exports", "core/component", "app/data/client_event", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/data/simple_event_scribe", ["module", "require", "exports", "core/component", "app/data/with_scribe", ], 
  (function (module, require, exports) 
  {
    function simpleEventScribe() 
    {
      ...
      this.after("initialize", (function () 
      {
        this.on("uiEnableEmailFollowAction", this.scribeSimpleEvent), 
        this.on("uiDisableEmailFollowAction", this.scribeSimpleEvent), 
        this.on("uiEmailFollowFormSubmitAction", this.scribeSimpleEvent);
      }));
    }
  ...
  define("app/utils/cookie", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    module.exports = (function (b, c, d) 
    {
      ...
      if(arguments.length > 1 && String(c) !== "[object Object]")
      {
        ...
        {
          var f = e.expires, g = new Date((new Date).getTime() + f * 24 * 60 * 60 * 1000);
          e.expires = g;
        }
  ...
  define("app/boot/scribing", ["module", "require", "exports", "app/data/scribe_transport", "app/data/scribe_monitor", "app/data/client_event", "app/data/tweet_actions_scribe", "app/data/block_or_report_scribe", "app/data/user_actions_scribe", "app/data/item_actions_scribe", "app/data/navigation_scribe", "app/data/update_scribe", "app/data/simple_event_scribe", "app/utils/cookie", ], 
  (function (module, require, exports) 
  {
    function initialize(a) 
    {
      ...
      scribeTransport.updateOptions(b), scribeTransport.registerEventHandlers(), 
      clientEvent.scribeContext = {
        client : "web",
        page : a.pageName,
      ...
      delete clientEvent.internalReferer, 
      a.loggedIn || (clientEvent.scribeData.user_id = 0), 
      (a.environment != "production" || a.preflight || a.scribesForScribeConsole) && ScribeMonitor.attachTo(document, {
        scribesForScribeConsole : a.scribesForScribeConsole
      }), 
      TweetActionsScribe.attachTo(document, a), 
      BlockOrReportScribe.attachTo(document, a), 
      UserActionsScribe.attachTo(document, a), 
      ItemActionsScribe.attachTo(document, a), 
      NavigationScribe.attachTo(document, a), 
      SimpleEventScribe.attachTo(document, a), 
      UpdateScribe.attachTo(document);
    }
    var scribeTransport = require("app/data/scribe_transport"), 
    ScribeMonitor = require("app/data/scribe_monitor"), 
    clientEvent = require("app/data/client_event"), 
    TweetActionsScribe = require("app/data/tweet_actions_scribe"), 
    BlockOrReportScribe = require("app/data/block_or_report_scribe"), 
    UserActionsScribe = require("app/data/user_actions_scribe"), 
    ItemActionsScribe = require("app/data/item_actions_scribe"), 
    NavigationScribe = require("app/data/navigation_scribe"), 
    UpdateScribe = require("app/data/update_scribe"), 
    SimpleEventScribe = require("app/data/simple_event_scribe"), 
    cookie = require("app/utils/cookie");
    module.exports = initialize;
  }));
  define("app/utils/push_state_enabled", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/ui/navigation", ["module", "require", "exports", "core/component", "app/utils/full_path", "app/utils/push_state_enabled", ], 
  (function (module, require, exports) 
  {
    function navigation() 
    {
      ...
      this.navigate = (function (a) 
      {
        ...
        if(a.shiftKey || a.ctrlKey || a.metaKey || a.which != undefined && a.which > 1)
          return;
        b = $(a.target), c = b.closest(this.attr.pushStateSelector), 
        c.length && ! a.isDefaultPrevented() && c.attr("href") && (this.trigger(c, "uiNavigate", {
          href : c.attr("href")
        }), 
        a.preventDefault(), 
      ...
      {
        this.hideSpinner(), this.trigger("uiBeforePageChanged", b), 
        ...
        $("body").attr("class", b.init_data.bodyFoucClassNames + " " + b.body_class_names), 
        this.select("docContainer").attr("class", b.doc_class_names), 
        this.select("pageContainer").attr("class", b.page_container_class_names), 
        b.canonical_url && $('link[rel="canonical"]').attr("href", b.canonical_url);
        var c = b.banners && ! b.fromCache ? b.banners + b.page : b.page;
        this.$node.find(b.init_data.viewContainer).html(c), b.isPopState || $(window).scrollTop(0), 
        using(b.module, (function (a) 
        {
          b.init_data.fromCache = b.fromCache, a(b.init_data), 
          $("body").removeClass(this.attr.baseFoucClass), 
          this.trigger("uiPageChanged", b);
        }).bind(this));
      }), 
      ...
      {
        b.state && (isSafari && (document.body.style.display = "none", document.body.offsetHeight, 
      ...
      this.after("initialize", (function () 
      {
        pushStateEnabled(this.attr.pushState) && (this.on("click", this.navigate), this.on(window, "popstate", this.onPopState), 
        this.on("dataPageRefresh", this.updatePage), 
        this.on("dataPageFetch", this.showSpinner));
      }));
    }
    var component = require("core/component"), fullPath = require("app/utils/full_path"), 
    isSafari = $.browser.safari === ! 0, 
    pushStateEnabled = require("app/utils/push_state_enabled"), 
    Navigation = component(navigation);
    module.exports = Navigation;
  }));
  define("app/utils/time", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    function Duration(a) 
    {
    ...
    {
      var b = {
        seconds : new Duration(a * 1000),
        minutes : new Duration(a * 1000 * 60),
        hours : new Duration(a * 1000 * 60 * 60),
        days : new Duration(a * 1000 * 60 * 60 * 24)
      };
      return b.second = b.seconds, b.minute = b.minutes, b.hour = b.hours, 
      b.day = b.days, 
      b;
    }
    time.now = (function () 
  ...
  define("app/utils/storage/core", ["module", "require", "exports", "core/compose", "core/advice", ], 
  (function (module, require, exports) 
  {
    function localStorage() 
    {
      ...
      {
        this.namespace = a, this.prefix = ["__", this.namespace, "__:", ].join(""), 
...
{          return window.DEBUG && window.DEBUG.enabled && console.error(c), 
          undefined;}
    ...
    function userData() 
    {
      ...
      {
        this.namespace = b, (this.dataStore = c(this.namespace)) || this.createStorageElement(), 
        this.xmlDoc = this.dataStore.xmlDocument, 
        this.xmlDocEl = this.xmlDoc.documentElement, 
        a[this.namespace] = a[this.namespace] || {
          
        };
      }), 
      this.createStorageElement = (function () 
      {
        this.dataStore = document.createElement("div"), this.dataStore.id = "__storage_" + this.namespace, 
        this.dataStore.style.display = "none", 
        document.appendChild(this.dataStore), 
        this.dataStore.addBehavior("#default#userData"), 
        this.dataStore.load(this.namespace);
      }), 
      ...
      this.setItem = (function (b, c) 
      {
        ...
        return d ? d.setAttribute("value", this.encode(c)) : (d = this.xmlDoc.createNode(1, "item", ""), d.setAttribute("key", b), 
        d.setAttribute("value", this.encode(c)), 
        this.xmlDocEl.appendChild(d), 
        a[this.namespace][b] = d), 
        this.dataStore.save(this.namespace), 
        c;
      }), 
    ...
    function supportsLocalStorage() 
    {
      if(doesLocalStorage === undefined)
        try
{          window.localStorage.setItem("~~~~", 1), window.localStorage.removeItem("~~~~"), 
          doesLocalStorage = ! 0;}
        catch(a)
{          doesLocalStorage = ! 1;}
    ...
    var compose = require("core/compose"), advice = require("core/advice"), 
    memoryStore = {
      
    }, 
    doesLocalStorage;
    compose.mixin(CoreStorage.prototype, [encoding, browserStore, advice.withAdvice, ]), 
    CoreStorage.clearAll = CoreStorage.prototype.clearAll, 
    module.exports = CoreStorage;
  }));
  define("app/data/notifications", ["module", "require", "exports", "app/utils/storage/core", "app/utils/time", ], 
  (function (module, require, exports) 
  {
    function Notification(a, b, c, d) 
    {
      this.key = b, this.timestamp = 0, this.active = a, this.seenFirstResponse = ! 1, 
      this.pollEvent = c, 
      this.paramAdder = d;
    }
    ...
    var Storage = require("app/utils/storage/core"), time = require("app/utils/time"), 
    pollDelay = 20000, 
    storage = new Storage("DM"), 
    filteredEndpoints = ["/i/users/recommendations", "/i/timeline", "/i/notifications/timeline", "/i/discover/timeline", "/i/search/timeline", "/i/profiles/show", "/messages", ];
    Notification.prototype = {
      ...
      update : (function (a) 
      {
        this.isResponseValid(a) ? this.reset() : ! this.seenFirstResponse && this.pollEvent && $(document).trigger(this.pollEvent), 
    ...
    Notifications.prototype = {
      init : (function (a) 
      {
        this.initialized = ! 0, this.dm = new Notification(a.toasts_dm, "d", "uiDMPoll", this.addDMData), 
        this.connect = new Notification(a.toasts_timeline, "t", null, (function () 
        {
          
        })), 
        this.spoonbill = new Notification(a.toasts_spoonbill, "n", null, this.addSpoonbillData), 
        this.spoonbill.shouldPoll = (function () 
        {
          return ! 0;
        }), 
        this.entries = [this.dm, this.connect, this.spoonbill, ], 
        a.toasts_dm_poll_scale && (pollDelay = a.toasts_dm_poll_scale * 1000);
      }),
  ...
  define("app/utils/querystring", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/utils/params", ["module", "require", "exports", "app/utils/querystring", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/data/with_auth_token", ["module", "require", "exports", "app/utils/auth_token", "core/utils", ], 
  (function (module, require, exports) 
  {
...
{            throw "Bad Key";}
        ...
        t = (function (a) 
        {
          var b = [], c = d ? [0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3, ] : [0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11, ], 
          e;
          for(e = 0;e < 16;e ++)
            b[e] = a[c[e]];
          return b;
        ...
        K = (function (a, b, c) 
        {
          var d = M.decode(a), e = d.slice(8, 16), f = n(k(b), e), 
          g = f.key, 
          h = f.iv;
        ...
        L = (function (a) 
        {
          ...
          {
            var c, d, e, f, g;
            return e = a & 2147483648, f = b & 2147483648, c = a & 1073741824, 
            d = b & 1073741824, 
          ...
          function l(a) 
          {
            var b, c = a.length, d = c + 8, e = (d - d % 64) / 64, f = (e + 1) * 16, 
            g = [], 
            h = 0, 
            i = 0;
            while(i < c)
              b = (i - i % 4) / 4, h = i % 4 * 8, g[b] = g[b] | a[i] << h, 
              i ++;
            return b = (i - i % 4) / 4, h = i % 4 * 8, g[b] = g[b] | 128 << h, 
            g[f - 2] = c << 3, 
            g[f - 1] = c >>> 29, 
            g;
          }
          ...
          var n = [], o, p, q, r, s, t, u, v, w, x = 7, y = 12, z = 17, 
          A = 22, 
          B = 5, 
          C = 9, 
          D = 14, 
          ...
          L = 15, 
          M = 21;
          n = l(a), t = 1732584193, u = 4023233417, v = 2562383102, 
          w = 271733878;
          for(o = 0;o < n.length;o += 16)
            p = t, q = u, r = v, s = w, t = h(t, u, v, w, n[o + 0], x, 3614090360), 
        ...
        M = (function () 
        {
          ...
          d = (function (b) 
          {
            ...
            for(f = 0;f < b.length;f += 4)
              d[0] = a.indexOf(b.charAt(f)), d[1] = a.indexOf(b.charAt(f + 1)), 
  ...
  define("app/utils/storage/with_crypto", ["module", "require", "exports", "app/utils/crypto/aes", ], 
  (function (module, require, exports) 
  {
    function withCrypto() 
    {
...
{          return this.removeItem(b), null;}
  ...
  define("app/utils/storage/with_expiry", ["module", "require", "exports", "app/utils/storage/core", ], 
  (function (module, require, exports) 
  {
    function withExpiry() 
    {
      ...
      {
        return typeof d == "number" ? this.ttl.setItem(b, this.now() + d) : this.ttl.removeItem(b), 
        a(b, c);
      })), 
      this.around("getItem", (function (a, b) 
      {
        var c = this.ttl.getItem(b);
        return typeof c == "number" && this.now() > c && this.removeItem(b), 
        a(b);
      })), 
  ...
  define("app/utils/storage/array/with_array", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    function withArray() 
    {
  ...
  define("app/utils/storage/array/with_max_elements", ["module", "require", "exports", "core/compose", "app/utils/storage/array/with_array", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/utils/storage/array/with_unique_elements", ["module", "require", "exports", "core/compose", "app/utils/storage/array/with_array", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/utils/storage/custom", ["module", "require", "exports", "core/compose", "app/utils/storage/core", "app/utils/storage/with_crypto", "app/utils/storage/with_expiry", "app/utils/storage/array/with_array", "app/utils/storage/array/with_max_elements", "app/utils/storage/array/with_unique_elements", ], 
  (function (module, require, exports) 
  {
    function storageConstr(a) 
    {
      ...
      var d = [];
      return a.withCrypto && d.push(withCrypto), a.withExpiry && d.push(withExpiry), 
      a.withArray && d.push(withArray), 
      a.withUniqueElements && d.push(withUniqueElements), 
      a.withMaxElements && d.push(withMaxElements), 
      d.length > 0 && compose.mixin(c.prototype, d), 
      lookup[b] = c, 
      c;
    }
    var compose = require("core/compose"), CoreStorage = require("app/utils/storage/core"), 
    withCrypto = require("app/utils/storage/with_crypto"), 
    withExpiry = require("app/utils/storage/with_expiry"), 
    withArray = require("app/utils/storage/array/with_array"), 
    withMaxElements = require("app/utils/storage/array/with_max_elements"), 
    withUniqueElements = require("app/utils/storage/array/with_unique_elements"), 
    lookup = {
      
    };
    module.exports = storageConstr;
  }));
  define("app/data/profile_info", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    var cache = {
  ...
  define("app/data/with_data", ["module", "require", "exports", "core/compose", "core/i18n", "core/utils", "app/data/notifications", "app/utils/params", "app/data/with_auth_token", "app/utils/storage/custom", "app/utils/storage/core", "app/data/profile_info", ], 
  (function (module, require, exports) 
  {
    ...
    function withData() 
    {
      ...
      var a = [], b = [];
      this.ajaxInProgress = Object.create(null), this.defaultAttrs({
        allowConcurrentRequests : ! 0
      }), 
      this.composeData = (function (a, b) 
      {
        return a = a || {
          
        }, b.eventData && (a.sourceEventData = b.eventData), 
        a;
      }), 
      ...
      this.createSuccessHandler = (function (b, c) 
      {
        return initializeXhrStorage(), (function (d, e, f) 
        {
          ...
          var g;
          e == "success" && (g = f.getResponseHeader("Redirect-Page-To")) && (window.location.href = g);
          var h = d, i = null, j = encodeURIComponent(c.url);
          if(d && d.hasOwnProperty("note") && d.hasOwnProperty("inner"))
          {
            h = d.inner, i = d.note;
            var k = f.getResponseHeader("x-transaction");
            k && k != xhrStorage.getItem(j) && (i.notCached = ! 0, xhrStorage.setItem(j, k));
          }
          h = this.composeData(h, c), c.cache_ttl && storage.setItem(j, {
            data : h,
            time : (new Date).getTime()
          }, 
          c.cache_ttl), 
          this.callSuccessHandler(b, h, c), 
          i && (notifications.updateNotificationState(i), i.notCached && this.trigger("dataNotificationsReceived", i)), 
          h.debug && this.trigger("dataSetDebugData", h.debug);
        }).bind(this);
      }), 
      ...
      this.createErrorHandler = (function (b, c, d, e) 
      {
        return (function (f) 
        {
          a.slice(a.indexOf(f), 1);
          var g = f && typeof f.getResponseHeader == "function" ? parseInt(f.getResponseHeader("retry-after"), 10) : null;
          if(c.retryIfUnavailable && f.status == 503 && g > 0)
          {
            d.retryIfUnavailable = ! 1, this.retryJSONRequestAfterDelay(d, e, g);
            return;
          }
          var h;
          try
{            h = JSON.parse(f.responseText), h && h.challengeName ? this.trigger(document, "dataInitialChallengeNeeded", h) : h && h.message && ! this.attr.noShowError && this.trigger("uiShowError", h);}
          catch(i)
{            h = {
              xhr : {
            ...
            f && f.statusText && (h.xhr.statusText = f.statusText);}

          h.message || (h.message = _('\ub0b4\ubd80 \uc11c\ubc84 \uc624\ub958.')), 
          h = this.composeData(h, c), 
          this.callErrorHandler(b, h, c);
        }).bind(this);
      }), 
      ...
      {
        var d, e, f;
        if(! this.attr.allowConcurrentRequests)
        {
          if(this.isAjaxInProgress(b))
            return;
          this.setAjaxInProgress(b);
        }
        b.retryIfUnavailable && (e = utils.merge(b), f = c);
        if(b.cache_ttl)
        {
          storage || (storage = new StorageConstr("with_data")), 
          d = storage.getItem(encodeURIComponent(b.url));
        ...
        var g = c == "POST" || c == "DELETE";
        g && b.isMutation === ! 1 && (g = ! 1), delete b.isMutation, 
        this.trigger && g && this.trigger("dataPageMutated"), 
        ["url", ].forEach((function (a) 
        {
          if(! b.hasOwnProperty(a))
            throw new Error("getJSONRequest called without required option: " + a, 
            arguments);
        }));
        var h = b.data || {
          
        }, i = b.headers;
        ["GET", "POST", ].indexOf(c) < 0 && (h = $.extend({
          _method : c
        }, h), c = "POST"), 
        c == "POST" && (h = this.addAuthToken(h), i && i["X-PHX"] && (h = this.addPHXAuthToken(h)));
        var j = $.extend({
          lang : ! 0
        }, b.echoParams);
        h = $.extend(h, this.extractParams(j, window.location)), 
        b.success && (b.success = this.createSuccessHandler(b.success, b));
        if(b.error || b.retryIfUnavailable)
          b.error = this.createErrorHandler(b.error, b, e, f);
        this.attr.allowConcurrentRequests || (b.complete = (function () 
        {
          this.unsetAjaxInProgress(b);
        }).bind(this)), 
        $.extend(h, notifications.extraParameters(b.url)), 
        Profile.info && Profile.info.presentation && $.extend(b.headers, {
          "X-PROF" : Profile.info.presentation
        }), 
        this.attr.includePageContext && this.attr.pageContext && (h.page_context = this.attr.pageContext);
        var k = $.ajax($.extend(b, {
          url : b.url,
          data : this.sortData(h),
          dataType : b.dataType || "json",
          type : c
        }));
        b.noAbortOnNavigate || a.push(k);
      }), 
      this.get = (function (a) 
      {
      ...
      this.isAjaxInProgress = (function (a) 
      {
        return this.ajaxInProgress[this.ajaxInProgressKey(a)];
      }), 
      this.setAjaxInProgress = (function (a) 
      {
        this.ajaxInProgress[this.ajaxInProgressKey(a)] = ! 0;
      }), 
      this.unsetAjaxInProgress = (function (a) 
      {
        delete this.ajaxInProgress[this.ajaxInProgressKey(a)];
      }), 
      this.ajaxInProgressKey = (function (a) 
      {
        return a._ajaxInProgressKey || (a._ajaxInProgressKey = a.url + JSON.stringify(a.data)), 
        a._ajaxInProgressKey;
      }), 
    ...
    var compose = require("core/compose"), _ = require("core/i18n"), 
    utils = require("core/utils"), 
    notifications = require("app/data/notifications"), 
    ...
    CoreStorage = require("app/utils/storage/core"), 
    Profile = require("app/data/profile_info"), 
    StorageConstr = customStorage({
      withExpiry : ! 0
    }), 
    storage, 
    xhrStorage;
  ...
  define("app/data/with_rollback_count", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    module.exports = (function () 
    {
      ...
      this.resetRollbackCount = (function () 
      {
        history.state && (history.state.rollbackCount = 0);
      });
    });
  }));
  define("app/data/navigation", ["module", "require", "exports", "core/component", "core/utils", "core/registry", "app/utils/time", "app/utils/full_path", "app/data/with_data", "app/data/with_rollback_count", "app/utils/push_state_enabled", ], 
  (function (module, require, exports) 
  {
    function navigationData() 
    {
      ...
      {
        var c = this.attr.assetsBasePath && this.attr.assetsBasePath.match(a), 
        d = b.init_data.assetsBasePath && b.init_data.assetsBasePath.match(a);
        return c && d && d[1] != c[1];
      }), 
      this.getPageData = (function (a) 
      {
        var b;
        this.trigger("dataBeforeNavigate"), this.attr.init_data.initialState && this.createInitialState(), 
        this.sweepPageCache(), 
          ...
          this.get({
            ...
            success : (function (b) 
            {
              ...
              if(b.init_data && b.page && b.module)
              {
                ...
                {
                  this.attr.viewContainer = b.init_data.viewContainer, 
                  this.navigateTo(c);
                  return;
                }
                this.cacheState(c, b);
      ...
      this.updatePageCache = (function (a, c) 
      {
        ...
        d && (d.page = this.select("viewContainer").html(), this.pageCacheTTLs[b] = time(d.cache_ttl).seconds.fromNow().getTime(), 
        d.page.length > this.attr.pushStatePageLimit && (delete this.pageCache[b], delete this.pageCacheTTLs[b])), 
      ...
      {
        this.rollbackCount() > 0 ? (e = utils.once(this.refreshPage.bind(this, a, b)), this.on("uiDidRollback", e), 
      ...
      this.createInitialState = (function () 
      {
        ...
        a.init_data = utils.merge(this.attr.init_data, ! 0), 
        delete a.init_data.initialState, 
      ...
      this.after("initialize", (function () 
      {
        pushStateEnabled(this.attr.pushState) ? (this.on("uiSwiftLoaded uiPageChanged", this.resetStateVariables), 
        this.on("uiSwiftLoaded", this.createInitialHistoryEntry), 
        this.on("uiNavigate", this.navigateUsingPushState), 
        ...
        this.on(window, "beforeunload", this.destroyCurrentPageState)) : (this.on("uiSwiftLoaded", this.resetStateVariables), this.on("uiNavigate", this.navigateUsingRedirect));
      }));
    }
    var component = require("core/component"), utils = require("core/utils"), 
    registry = require("core/registry"), 
    time = require("app/utils/time"), 
    fullPath = require("app/utils/full_path"), 
    withData = require("app/data/with_data"), 
    withRollbackCount = require("app/data/with_rollback_count"), 
    pushStateEnabled = require("app/utils/push_state_enabled"), 
    NavigationData = component(navigationData, withData, withRollbackCount);
    module.exports = NavigationData;
  }));
  define("app/data/teardown_manager", ["module", "require", "exports", "core/component", "core/registry", ], 
  (function (module, require, exports) 
  {
    function TeardownManager() 
    {
      ...
      this.doTeardown = (function (a, b) 
      {
        ...
        {
          this.teardownInstance(registry.allInstances[a].instance, b.teardownContext);
        }), 
        this);
      }), 
  ...
  define("app/utils/is_visible", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/utils/is_enabled", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/utils/with_keyboard_modality", ["module", "require", "exports", "app/utils/is_visible", "app/utils/is_enabled", ], 
  (function (module, require, exports) 
  {
...
{            }
      ...
      this.createFirstLastTabStop = (function (a) 
      {
        a.prepend('<div class="' + this.attr.firstTabStopClass + '" tabindex="0"></div>'), 
        a.append('<div class="' + this.attr.lastTabStopClass + '" tabindex="0"></div>');
      }), 
  ...
  define("app/utils/prevent_next_tooltip", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
  ...
  deferred('$lib/bootstrap_tooltip.js', (function () 
  {
    ! (function ($) 
    {
      ...
      }, e = ".visuallyhidden, .u-hiddenVisually", 
      f = (function (a, b) 
      {
      ...
      f.prototype = {
        ...
        init : (function (a, b, c) 
        {
          this.type = a, this.$element = $(b), this.options = this.getOptions(c), 
          this.enabled = ! 0, 
          this.options.trigger != "manual" && (this.$element.on("mouseenter focus", this.options.selector, $.proxy(this.enter, this)), 
          this.$element.on("mouseleave blur", this.options.selector, $.proxy(this.leave, this)), 
        ...
        getOptions : (function (a) 
        {
          ...
          a, 
          this.$element.data()), 
          a.delay && typeof a.delay == "number" && (a.delay = {
            show : a.delay,
            hide : 100
          }), 
          a;
        ...
        {
          var a = this.$element.text().trim(), b = ! ! this.$element.find("img").length, 
          c = (function (a) 
          {
            return $(a).text().trim();
          }), 
        ...
        getLabelEl : (function () 
        {
          ...
          return this.$element.is("input") && (b = this.$element.closest("label"), ! b.length && a && (b = $("label[for=" + a + "]"))), 
          b;
        }),
        ...
        getHiddenLabel : (function () 
        {
          ...
          return a.length || (b = this.getLabelEl(), b.is(e) ? a = b : a = b.find(e)), 
          a;
        }),
        shouldShow : (function () 
        {
        ...
        show : (function () 
        {
          ...
          {
            b(this.timeout), $(".tooltip").remove(), this.$tip = null, 
            a = this.tip(), 
            this.setContent(), 
            this.options.animation && a.addClass("fade"), 
            g = typeof this.options.placement == "function" ? this.options.placement.call(this, a[0], this.$element[0]) : this.options.placement, 
            c = /in/.test(g), 
            this.applyARIA(), 
            a.remove().css({
              top : 0,
            ...
            this.$element.addClass("in"), a.css(h).addClass(g).addClass("in"), 
            a.trigger("uiTooltipShow");
          }
        }),
        applyARIA : (function () 
        {
          var a = this.getLabelText(), b = this.$element.find("img").attr("alt"), 
          c = a + b, 
          d = ! this.hasHiddenLabel() && c.trim() != this.getTitle();
        ...
        hide : (function () 
        {
          ...
          b(a.timeout), this.$element.removeAttr("aria-describedby"), 
          c.removeClass("in"), 
          this.$element.removeClass("in"), 
          c.trigger("uiTooltipHide"), 
          $.support.transition && this.$tip.hasClass("fade") ? d() : c.remove();
        }),
        fixTitle : (function () 
        {
          var a = this.$element;
        ...
        getPosition : (function (a) 
        {
          ...
          return b.is("a") && b.find(c).length && (b = b.find(c)), $.extend({
      ...
      $.fn.tooltip.clearAllPendingTimeouts = d, 
      $.fn.tooltip.Constructor = f, 
      $.fn.tooltip.defaults = {
        animation : ! 0,
        delay : 1000,
        selector : ! 1,
  ...
  define("app/ui/with_dropdown", ["module", "require", "exports", "core/compose", "app/utils/with_keyboard_modality", "app/utils/prevent_next_tooltip", "$lib/bootstrap_tooltip.js", ], 
  (function (module, require, exports) 
  {
    function withDropdown() 
    {
      ...
      this.toggleDisplay = (function (a) 
      {
        ...
        this.isOpen() && ! this.$dropdown.is(b) && this.closeDropdown(), 
        this.$dropdown = b, 
        this.isOpen() ? this.notifyCloseRequested() : this.notifyOpenRequested(), 
        a.preventDefault(), 
        a.stopImmediatePropagation(), 
        $(a.target).closest(".js-tooltip").trigger("blur");
      }), 
      ...
      this.openDropdown = (function () 
      {
        ...
        this.createFirstLastTabStop(a), this.on(a.find(this.attr.lastTabStopSelector), "focus", this.focusFirstAvailableControl), 
        this.on(a.find(this.attr.firstTabStopSelector), "focus", this.focusLastAvailableControl), 
      ...
      this.notifyOpenRequested = (function () 
      {
        if(this.isOpen())
          return;
        this.$dropdown.find(this.attr.togglerSelector).closest(".js-tooltip").tooltip("disable"), 
        this.trigger(this.$dropdown, {
      ...
      this.closeDropdown = (function () 
      {
        if(! this.isOpen())
          return;
        var a = this.$dropdown.find(this.attr.dropDownMenuSelector);
        this.off(a.find(this.attr.lastTabStopSelector), "focus", this.focusFirstAvailableControl), 
        this.off(a.find(this.attr.firstTabStopSelector), "focus", this.focusLastAvailableControl), 
        this.removeFirstLastTabStop(a), 
      ...
      this.notifyCloseRequested = (function () 
      {
        if(! this.isOpen())
          return;
        this.$dropdown.find(this.attr.togglerSelector).closest(".js-tooltip").tooltip("enable"), 
        this.trigger(this.$dropdown, {
      ...
      this.closeAndRestoreFocus = (function (a) 
      {
        ...
        if(this.activeEl)
        {
          a.preventDefault();
          try
{            preventNextTooltip(this.activeEl), this.activeEl.focus(), 
            this.activeEl = null;}
          catch(a)
{            }
      ...
      this.close = (function (a) 
      {
        if(! this.isOpen())
          return;
        var b = a.target, c = $(b), d = this.$dropdown.find(this.attr.dropDownMenuSelector), 
        e = this.$dropdown.find(this.attr.togglerSelector), 
        f = d.is(b) || $.contains(d[0], b), 
        g = ! ! e.length && (e.is(b) || $.contains(e[0], b)), 
        h = c.is(this.attr.preventCloseSelector) || ! ! c.closest(this.attr.preventCloseSelector, this.$dropdown[0]).length;
        if(f || g || h)
          return;
        this.notifyCloseRequested();
      }), 
      ...
      {
        var a;
        this.isOpen() && (a = this.$dropdown.find(this.attr.dropDownMenuSelector), 
        this.focusNextAvailableControl("first", a));
      }), 
      this.focusLastAvailableControl = (function () 
      {
        var a;
        this.isOpen() && (a = this.$dropdown.find(this.attr.dropDownMenuSelector), 
        this.focusNextAvailableControl("last", a));
      }), 
      this.after("initialize", (function () 
      {
        ...
        this.on(document, "uiCloseDropdowns", this.notifyCloseRequested), 
        this.on(document, "click", this.close), 
        this.on(document, "uiShortcutEsc", this.closeAndRestoreFocus), 
        this.on(document, "uiBeforePageChanged uiPageChanged uiNavigate uiForceDropdownClosed", 
        this.closeDropdown);
      }));
    }
    var compose = require("core/compose"), withKeyboardModality = require("app/utils/with_keyboard_modality"), 
    preventNextTooltip = require("app/utils/prevent_next_tooltip");
    require("$lib/bootstrap_tooltip.js"), module.exports = withDropdown;
  }));
  define("app/ui/with_dropdownmenu", ["module", "require", "exports", "core/compose", "app/ui/with_dropdown", "app/utils/is_visible", "app/utils/is_enabled", ], 
  (function (module, require, exports) 
  {
    function withDropdownMenu() 
    {
      ...
      this.applyARIAToMenuItems = (function () 
      {
        ...
        this.$dropdown.find(this.attr.menuItemSelector).each((function (a, b) 
        {
      ...
      {
        var a = this.$dropdown.find(this.attr.menuListSelector), 
        b = this.$dropdown.find(this.attr.togglerSelector), 
        c;
        b.length && ! (c = b.attr("id")) && (c = "menu-" + instances ++, b.attr("id", c)), 
        a.attr({
          tabIndex : - 1,
          role : "menu"
        }), 
      ...
      this.moveSelection = (function (a) 
      {
        ...
        if(! b)
          return;
        var c = this.$dropdown.find(this.attr.menuListSelector).find("[role=menuitem]"), 
        d = this.$dropdown.find(this.attr.selectedMenuItemSelector), 
        e, 
        f;
        d.length && (f = c.index(d), f = b == "next" ? f + 1 : f - 1, e = c.eq(f));
        if(! e || e && ! e.length)
          e = b == "next" ? c.first() : c.last();
        e.length && (d.removeClass(this.attr.selectedMenuItemClass), e.addClass(this.attr.selectedMenuItemClass), 
        e[0].focus(), 
        a.preventDefault());
      }), 
      this.applyARIAAndFocus = (function (a) 
      {
        ...
        b && b.is(a.target) && (this.applyARIAToMenu(), this.applyARIAToMenuItems(), 
        c = this.$dropdown.find(this.attr.menuListSelector), 
      ...
      {
        var b = this.$dropdown;
        b && b.is(a.target) && (b.find(this.attr.menuListSelector).attr("aria-hidden", ! 0), 
        b.find(this.attr.selectedMenuItemSelector).removeClass(this.attr.selectedMenuItemClass));
      }), 
    ...
    var compose = require("core/compose"), withDropdown = require("app/ui/with_dropdown"), 
    isVisible = require("app/utils/is_visible"), 
    isEnabled = require("app/utils/is_enabled"), 
    instances = 0;
    module.exports = withDropdownMenu;
  }));
  define("app/ui/language_dropdown", ["module", "require", "exports", "core/component", "app/ui/with_dropdownmenu", ], 
  (function (module, require, exports) 
  {
    var defineComponent = require("core/component"), withDropdownMenu = require("app/ui/with_dropdownmenu"), 
    LanguageDropdown = defineComponent(withDropdownMenu);
    module.exports = LanguageDropdown;
  }));
  define("app/ui/google", ["module", "require", "exports", "core/component", ], 
  (function (module, require, exports) 
  {
    function googleAnalytics() 
    {
      ...
      this.initGoogle = (function () 
      {
        ...
        ! /^yes$|^1$/.test(navigator.msDoNotTrack || navigator.doNotTrack || window.doNotTrack) && this.attr.allowAdsPersonalization && ga("require", "displayfeatures"), 
      ...
      this.getPageName = (function () 
      {
        ...
        return this.attr.loggedIn && b == "profile" && this.screenNameRE.test(location.pathname) && (b = "self"), 
        "/" + [a, b, this.attr.sectionName, ].join("/");
      }), 
      this.after("initialize", (function () 
      {
        this.screenNameRE = new RegExp("^/" + this.attr.screenName + "(/.*)?$"), 
        this.on("uiSwiftLoaded", this.initGoogle), 
        this.on("uiPageChanged", this.trackPageChange), 
  ...
  define("app/data/user_info", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    var user = {
      ...
      set : (function (a) 
      {
        user.screenName = a.screenName, user.fullName = a.fullName, 
        user.deciders = a.deciders || {
  ...
  define("app/ui/macaw_nymizer", ["module", "require", "exports", "core/component", "app/data/user_info", "app/utils/params", ], 
  (function (module, require, exports) 
  {
    function macawNymizer() 
    {
      ...
      this.after("initialize", (function () 
      {
        userInfo.getDecider("enableMacawNymizerConversionLanding") && ((! this.attr.checkLandingParam || this.hasLandingParam()) && this.on("uiSwiftLoaded", this.renderPixel), 
        this.on("MNConversion", this.conversion));
      }));
    }
    var defineComponent = require("core/component"), userInfo = require("app/data/user_info"), 
    params = require("app/utils/params"), 
    MacawNymizer = defineComponent(macawNymizer);
    module.exports = MacawNymizer;
  }));
  define("app/ui/impression_cookies", ["module", "require", "exports", "core/component", "app/utils/cookie", ], 
  (function (module, require, exports) 
  {
    function impressionCookies() 
    {
      ...
      this.triggerPromotedClickAndSetCookie = (function (a, b) 
      {
        if(this.linkIsLocalAndWihoutAHashBang(b.hostName, b.href) && b.impressionCookie)
        {
          ...
          var c = new Date, d = 60000, e = new Date(c.getTime() + d);
  ...
  define("app/data/promoted_logger", ["module", "require", "exports", "core/component", "app/data/with_data", "app/data/user_info", ], 
  (function (module, require, exports) 
  {
    function promotedLogger() 
    {
      ...
      this.logPromotedTweetLinkClick = (function (a) 
      {
        ...
        c = $(a.target).closest("[data-impression-id]").attr("data-disclosure-type"), 
        d = $(a.target).closest(this.attr.tweetLinkSelector).attr("href");
        if(! b)
          return;
        this.logEvent({
          event : "url_click",
      ...
      {
        var c = b.impressionId, d = b.disclosureType, e = b.embeddedMediaLogged, 
        f = b.videoAutoplay && userInfo.getDecider("promoted_video_logging_enabled");
        if(! c || e || f)
          return;
        this.logEvent({
          event : "view_details",
      ...
      this.logPromotedVideoEvent = (function (a, b) 
      {
        ...
        if(c)
        {
          ...
          typeof b.video_uuid != "undefined" && (e.video_uuid = b.video_uuid), 
          typeof b.video_type != "undefined" && (e.video_type = b.video_type), 
          this.logEvent(e);
        }
      }), 
      this.after("initialize", (function () 
      {
        ...
        this.on("uiTweetsDisplayed", this.logPromotedTweetImpression), 
        this.on("click", {
        ...
        this.on("uiHasExpandedTweet uiHasClickedTweet", this.logPromotedTweetDetails), 
        this.on("uiTweetDismissed", this.logPromotedTweetDismiss), 
        this.on("uiDidShareViaEmailSuccess", this.logPromotedTweetShareViaEmail), 
        ...
        this.on("uiVideoEvent", this.logPromotedVideoEvent);
      }));
    }
    var defineComponent = require("core/component"), withData = require("app/data/with_data"), 
    userInfo = require("app/data/user_info"), 
    PromotedLogger = defineComponent(promotedLogger, withData);
    module.exports = PromotedLogger;
  }));
  define("app/ui/message_drawer", ["module", "require", "exports", "core/component", ], 
  (function (module, require, exports) 
  {
    function messageDrawer() 
    {
      ...
      this.calculateFadeTimeout = (function (a, b) 
      {
        if(b != null)
          return b;
        var c = a.split(" ").length, d = c * 1000 / 5 + 225;
      ...
      this.showMessage = (function (a, b, c) 
      {
        ...
        clearTimeout(this.messageTimeout), this.timeoutExpired = ! 1, 
        this.dialogPresent() && (d.top = 0), 
        this.$node.stop(), 
        this.$node.removeClass(this.attr.hiddenClass), 
        this.$node.animate(d, 300, (function () 
        {
          this.scheduleClose(b, this.calculateFadeTimeout(a, c));
        }).bind(this)), 
        this.select("textSelector").html(a), 
        this.select("closeSelector").toggle(! ! b);
      }), 
  ...
  define("app/ui/tooltips", ["module", "require", "exports", "core/component", "$lib/bootstrap_tooltip.js", ], 
  (function (module, require, exports) 
  {
    function tooltips() 
    {
      ...
      this.hideEvents = ["uiBeforePageChanged", "uiDialogOpened", "uiDialogClosed", "uiDropdownOpened", "uiDropdownClosed", "uiGalleryOpened", ], 
      this.hide = (function () 
      {
  ...
  define("app/ui/forms/screen_reader_label", ["module", "require", "exports", "core/component", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/data/ttft_navigation", ["module", "require", "exports", "core/component", "app/data/scribe_transport", ], 
  (function (module, require, exports) 
  {
    function ttftNavigate() 
    {
      ...
      {
        this.log("afterPageChanged", a, b), time.afterPageChanged = + (new Date), 
        ...
        1), 
        time.ajaxCount = this.ajaxCountdown = $.active, 
        $.active && this.hookAjaxListener(! 0);
      }), 
      this.timelineRefreshRequest = (function (a, b) 
      {
        clearTimeout(this.timelineListener), this.hookTimelineListener(! 1), 
        b.navigated && (this.listeningForTimeline = ! 0, this.hookTimelineResults(! 0));
      }), 
      this.timelineSuccess = (function (a, b) 
      {
        this.log("timelineSuccess", a, b), this.listeningForTimeline = ! 1, 
        this.hookTimelineResults(! 1), 
        time.timelineSuccess = + (new Date), 
        this.report();
      }), 
      this.timelineError = (function (a, b) 
      {
        this.log("timelineError", a, b), this.listeningForTimeline = ! 1, 
        this.hookTimelineResults(! 1), 
        this.report();
      }), 
      this.ajaxComplete = (function (a, b) 
      {
        -- this.ajaxCountdown || (this.log("ajaxComplete", a, b), this.hookAjaxListener(! 1), 
        time.ajaxComplete = + (new Date), 
        this.report());
      }), 
      this.report = (function () 
      {
        ...
        time.ajaxCount && (a.ajax_complete_time = time.ajaxComplete), 
        this.scribeTransport.send(a, "route_timing"), 
        this.log(a);
      }), 
      this.log = (function () 
      {
      ...
      this.scribeTransport = scribeTransport, 
      this.hookAjaxListener = (function (a) 
      {
      ...
      {
        this[a ? "on" : "off"]("dataGotMoreTimelineItems", this.timelineSuccess), 
        this[a ? "on" : "off"]("dataGotMoreTimelineItemsError", this.timelineError);
      }), 
      this.after("initialize", (function () 
      {
  ...
  define("app/ui/banners/eu_cookie", ["module", "require", "exports", "core/component", "app/utils/cookie", ], 
  (function (module, require, exports) 
  {
    function euCookie() 
    {
  ...
  define("app/ui/keyboard_shortcuts", ["module", "require", "exports", "core/component", "core/utils", ], 
  (function (module, require, exports) 
  {
    function keyBoardShortcuts() 
    {
      ...
      {
        return b.shift && shiftKeyMap[a] || b.meta && metaKeyMap[a] || keyMap[a] || String.fromCharCode(a).toLowerCase();
      }), 
      ...
      {
        var b, c, d, e = this.charFromKeyCode(a.keyCode || a.which, {
          shift : a.shiftKey,
          meta : a.metaKey || a.ctrlKey,
          alt : a.altKey
        }), 
        f = this.shortcutEvents[this.lastKey + e] || this.shortcutEvents[e], 
        g = {
          fromShortcut : ! 0
        };
        f && e != this.lastKey ? (a.preventDefault(), typeof f == "string" ? b = f : (b = f.type, d = f.defaultFn, f.data && (g = utils.merge(g, f.data))), 
        d && (c = {
          type : b,
      ...
      {
        var b = a.target, c, d;
        return a.keyCode == 13 && (this.isMetaKey(a) ? c = ! 0 : d = ! 0), 
        this.isMetaKey(a) && a.keyCode != 13 || this.isTextField(b) && ! c && a.keyCode != 27 || d && this.isWhiteListedElement(b) || this.isFunctionKey(a);
      }), 
      this.onKeyDown = (function (a) 
      {
        this.ignore(a) || this.triggerShortcut(a);
      }), 
      ...
      this.after("initialize", (function () 
      {
        this.on("keydown", this.onKeyDown), this.attr.routes && utils.push(this.routes, this.attr.routes), 
    ...
    UI_SHORTCUT_NAVIGATE = "uiShortcutNavigate", 
    KeyBoardShortcuts = defineComponent(keyBoardShortcuts);
    module.exports = KeyBoardShortcuts;
  }));
  define("app/ui/dynamic_image_loader", ["module", "require", "exports", "core/component", ], 
  (function (module, require, exports) 
  {
    function dynamicImageLoader() 
    {
      ...
      this.swapPlaceholdersForImages = (function () 
      {
        ...
        {
          var b = $("<img>").appendTo(a.parentNode), c = b[0], d = a.getAttribute("data-width"), 
          e = a.getAttribute("data-height"), 
          f = a.getAttribute(this.attr.imageAltAttr), 
          g = parseInt(a.getAttribute(this.attr.imageOffsetAttr));
          c.src = a.getAttribute(this.attr.imageSourceAttr), d && c.setAttribute("width", d), 
          e && c.setAttribute("height", e), 
          f && (c.alt = f), 
          g && (c.style.marginTop = g + "px"), 
          $(a).remove();
        }), 
        this);
      }), 
  ...
  define("app/ui/aria_event_logger", ["module", "require", "exports", "core/component", "core/i18n", "core/utils", ], 
  (function (module, require, exports) 
  {
    function ariaEventLogger() 
    {
      ...
      this.MESSAGES = {
        FAVORITED : _('\uad00\uc2ec\uae00'),
        UNFAVORITED : _('\uad00\uc2ec\uae00\uc774 \ucde8\uc18c\ub428'),
        RETWEETED : _('\ub9ac\ud2b8\uc717\ud568'),
        UNRETWEETED : _('\ub9ac\ud2b8\uc717\uc774 \ucde8\uc18c\ub428'),
        EXPANDED : _('\ud3bc\uccd0\uc9d0'),
        COLLAPSED : _('\uc811\ud798'),
        RENDERING_CONVERSATION : _('\ub300\ud654 \ubd88\ub7ec\uc624\ub294 \uc911.'),
        CONVERSATION_RENDERED : _('\ub300\ud654 \ub0b4\uc6a9\uc744 \ubd88\ub7ec\uc654\uc2b5\ub2c8\ub2e4. j \ud639\uc740 k\ub97c \ub20c\ub7ec \ud2b8\uc717\uc744 \ud655\uc778\ud558\uc138\uc694.'),
        CONVERSATION_START : _('\ub300\ud654\uc758 \uc2dc\uc791.'),
        CONVERSATION_END : _('\ub300\ud654\uc758 \ub05d.'),
        NEW_ITEMS_BAR_VISIBLE : _('\uc0c8 \ud2b8\uc717\uc774 \uc788\uc2b5\ub2c8\ub2e4. \ub9c8\uce68\ud45c(.) \ud0a4\ub97c \ub20c\ub7ec \ud655\uc778\ud558\uc138\uc694.')
      }, 
      ...
      this.logMessage = (function (a, b) 
      {
        if(! this.$log)
          return;
        b || (b = "assertive"), b != this.$log.attr("aria-live") && this.$log.attr("aria-live", b), 
        this.$log.append("<p>" + a + "</p>"), 
      ...
      {
        this.typeAheadResultsVisible && ! ! b.query && (b.numResults > 1 ? this.logMessage(_('\ucd94\ucc9c \uc0ac\uc6a9\uc790 {{numResults}}\uba85', 
        {
          numResults : b.numResults
        }), 
        "polite") : this.logMessage(_('\ucd94\ucc9c \uc0ac\uc6a9\uc790 {{numResults}}\uba85', 
        {
          numResults : b.numResults
        }), 
        "polite"));
      ...
      this.after("initialize", (function () 
      {
        ...
        this.logEvent("FAVORITED")), 
        this.on(document, "uiDidUnfavoriteTweet dataFailedToFavoriteTweet", 
        this.logEvent("UNFAVORITED")), 
        ...
        this.on(document, "uiHasExpandedTweet", this.logEvent("EXPANDED")), 
        this.on(document, "uiHasCollapsedTweet", this.logEvent("COLLAPSED")), 
        ...
        this.on(document, "uiNextItemSelected", this.logConversationEnd), 
        this.on(document, "uiPreviousItemSelected", this.logConversationStart), 
        this.on(document, "uiNewItemsBarVisible", this.logEvent("NEW_ITEMS_BAR_VISIBLE")), 
        ...
        this.on(document, "uiTypeaheadResultsShown", utils.debounce(this.logTypeAheadResultsVisible, this.attr.typeaheadDebounceInterval)), 
        this.on(document, this.CLEAR_LOG_EVENTS, this.clearLog);
      }));
    }
    var defineComponent = require("core/component"), _ = require("core/i18n"), 
    utils = require("core/utils"), 
    ARIAEventLogger = defineComponent(ariaEventLogger);
    module.exports = ARIAEventLogger;
  }));
  define("app/data/scriber", ["module", "require", "exports", "core/component", "app/data/with_scribe", ], 
  (function (module, require, exports) 
  {
    function scriber() 
    {
  ...
  define("app/ui/mute_user", ["module", "require", "exports", "core/component", "app/data/with_interaction_data_scribe", ], 
  (function (module, require, exports) 
  {
    function muteUser() 
    {
      ...
      this.doAction = (function (a, b, c) 
      {
        if(b.itemType == "tweet")
          return;
        b.modClass = "muting", b.modOp = a == "Mute" ? "addClass" : "removeClass", 
        delete b.el;
        var d = this.$node.find("[data-user-id=" + b.userId + "]");
        d[b.modOp]("muting"), this.trigger("uiUpdateMuteButtonState", b), 
        c || (this.trigger("uiCloseDropdowns"), this.trigger("uiHideMessage"), 
        this.trigger("ui" + a + "UserAction", b));
      }), 
        ...
        return (function (b, c) 
        {
          ...
          if(e)
          {
            ...
            if(d.closest("#profile_popup")[0])
              ...
              if(d.closest(".profile-page-header")[0] || d.closest(".ProfileNav-item--userActions"))
                c.scribeContext.component = "profile_follow_card";
          }
          else
            e = d.closest(".tweet")[0] || d.closest(".ProfileTweet")[0], 
            c.scribeContext.component = "tweet", 
            c.scribeContext.element = "tweet_actions_dropdown";
    ...
    var defineComponent = require("core/component"), withInteractionDataScribe = require("app/data/with_interaction_data_scribe"), 
    MuteUser = defineComponent(muteUser, withInteractionDataScribe);
    module.exports = MuteUser;
  }));
  define("app/data/mute_user", ["module", "require", "exports", "core/component", "app/data/with_data", ], 
  (function (module, require, exports) 
  {
    function muteUser() 
    {
    ...
    var defineComponent = require("core/component"), withData = require("app/data/with_data"), 
    MuteUser = defineComponent(muteUser, withData);
    module.exports = MuteUser;
  }));
  deferred('$bower_components/jquery-placeholder/jquery.placeholder.js', 
  (function () 
  {
    (function (a, b, $) 
    {
...
{                c = $("<input>").attr($.extend(j(this), {
            ...
            e = e.removeAttr("id").hide().prev().attr("id", e.data("placeholder-id")).show(), 
            h && d.type == "password" && e.focus();
          }
...
{          if(b.selection)
          {
            ...
            d.collapse(! 0), d.moveEnd("character", 0), d.moveStart("character", 0), 
            d.select();
          }
          else
...
{          }
      ...
      var c = "placeholder" in b.createElement("input"), d = "placeholder" in b.createElement("textarea"), 
      e = $.fn, 
      f = $.valHooks, 
      g, 
      h, 
      ...
      g = {
        ...
        {
          var c = $(a);
          return c.data("placeholder-enabled") ? (b == "" ? (a.value = b, m.call(a)) : c.hasClass("placeholder") ? l.call(a, ! 0, b) || (a.value = b) : a.value = b, 
          c) : c.data("placeholder-password") ? (c.next()[0].value = b, b != "" && l.call(a), c) : a.value = b;
        })
      }, 
      c || (f.input = g), 
      d || (f.textarea = g), 
  ...
  define("app/boot/common", ["module", "require", "exports", "app/utils/auth_token", "app/boot/scribing", "app/ui/navigation", "app/data/navigation", "app/data/teardown_manager", "app/ui/language_dropdown", "app/ui/google", "app/ui/macaw_nymizer", "app/ui/impression_cookies", "app/data/promoted_logger", "app/ui/message_drawer", "app/ui/tooltips", "app/ui/forms/screen_reader_label", "app/data/ttft_navigation", "app/utils/cookie", "app/utils/querystring", "app/data/user_info", "app/ui/banners/eu_cookie", "app/ui/keyboard_shortcuts", "app/ui/dynamic_image_loader", "app/ui/aria_event_logger", "app/data/scriber", "app/ui/mute_user", "app/data/mute_user", "$bower_components/jquery-placeholder/jquery.placeholder.js", ], 
  (function (module, require, exports) 
  {
    ...
    var authToken = require("app/utils/auth_token"), scribing = require("app/boot/scribing"), 
    NavigationUI = require("app/ui/navigation"), 
    NavigationData = require("app/data/navigation"), 
    TeardownManager = require("app/data/teardown_manager"), 
    LanguageDropdown = require("app/ui/language_dropdown"), 
    GoogleAnalytics = require("app/ui/google"), 
    MacawNymizer = require("app/ui/macaw_nymizer"), 
    ImpressionCookies = require("app/ui/impression_cookies"), 
    PromotedLogger = require("app/data/promoted_logger"), 
    MessageDrawer = require("app/ui/message_drawer"), 
    Tooltips = require("app/ui/tooltips"), 
    ScreenReaderLabel = require("app/ui/forms/screen_reader_label"), 
    TTFTNavigation = require("app/data/ttft_navigation"), 
    cookie = require("app/utils/cookie"), 
    querystring = require("app/utils/querystring"), 
    userInfo = require("app/data/user_info"), 
    EuCookie = require("app/ui/banners/eu_cookie"), 
    KeyboardShortcuts = require("app/ui/keyboard_shortcuts"), 
    DynamicImageLoader = require("app/ui/dynamic_image_loader"), 
    ARIAEventLogger = require("app/ui/aria_event_logger"), 
    Scriber = require("app/data/scriber"), 
    MuteUser = require("app/ui/mute_user"), 
    MuteUserData = require("app/data/mute_user");
    require("$bower_components/jquery-placeholder/jquery.placeholder.js");
    var ttftNavigationEnabled = ! 1, LOG_METHODS = ["log", "warn", "debug", "info", ], 
    NO_OP = (function () 
    {
    ...
    module.exports = (function (b) 
    {
      ...
      shimConsole(d && ! window.DEBUG.enabled), authToken.set(b.formAuthenticityToken), 
      userInfo.set(b), 
      ImpressionCookies.attachTo(document, {
        noTeardown : ! 0
      }), 
      scribing(b), 
      PromotedLogger.attachTo(document, {
        noTeardown : ! 0
      }), 
      Scriber.attachTo(document), 
      ...
      TeardownManager.attachTo(document), 
      NavigationData.attachTo(document, {
        init_data : b,
        pushState : b.pushState,
      ...
      $.browser.msie && parseInt($.browser.version, 10) == 10 && ScreenReaderLabel.attachTo(document, {
        noTeardown : ! 0
      }), 
      ...
      b.loggedIn || LanguageDropdown.attachTo(".js-language-dropdown"), 
      b.initialState && b.initialState.ttft_navigation && (ttftNavigationEnabled = ! 0), 
      ttftNavigationEnabled && TTFTNavigation.attachTo(document, {
        pageName : b.pageName,
        sectionName : b.sectionName
      }), 
      EuCookie.attachTo(".eu-cookie-notice"), 
      b.loggedIn && (initialLoginTWID = getTWID(), setInterval(verifySession, 10000)), 
      GoogleAnalytics.attachTo(document, {
        pageName : b.pageName,
        sectionName : b.sectionName,
  ...
  define("app/ui/with_scrollbar_width", ["module", "require", "exports", ], 
  (function (module, require, exports) 
  {
    ...
    (function ($) 
    {
      ...
      var a = $.event, b = a.special, c = b.drag = {
        ...
        add : (function (b) 
        {
          ...
          d.related += 1, ! d.live && b.selector && (d.live = ! 0, a.add(this, "draginit." + c.livekey, c.delegate)), 
          $.each(c.defaults, (function (a, b) 
          {
        ...
        setup : (function () 
        {
          ...
          $.data(this, c.datakey, b), a.add(this, "mousedown", c.init, b), 
        ...
        teardown : (function () 
        {
          if($.data(this, c.datakey).related)
            return;
          $.removeData(this, c.datakey), a.remove(this, "mousedown", c.init), 
          a.remove(this, "draginit", c.delegate), 
          c.textselect(! 0), 
        ...
        init : (function (d) 
        {
          ...
          if(e.handle && ! $(d.target).closest(e.handle, d.currentTarget).length)
            return;
          e.propagates = 1, e.interactions = [c.interaction(this, e), ], 
          e.target = d.target, 
          e.pageX = d.pageX, 
          e.pageY = d.pageY, 
          e.dragging = null, 
          f = c.hijack(d, "draginit", e);
          if(! e.propagates)
            return;
          ...
          c.textselect(! 1), 
          a.add(document, "mousemove mouseup", c.handler, e), 
          ! 1;
        }),
        ...
        handler : (function (d) 
        {
          ...
          switch(d.type){
            ...
            case "mouseup":
              a.remove(document, "mousemove mouseup", c.handler), e.dragging && (e.drop !== ! 1 && b.drop && b.drop.handler(d, e), c.hijack(d, "dragend", e)), 
              c.textselect(! 0), 
              e.click === ! 1 && e.dragging && ($.event.triggered = ! 0, setTimeout((function () 
              {
                $.event.triggered = ! 1;
              }), 
              20), 
        ...
        delegate : (function (b) 
        {
          ...
          return $.each(f.live || [], (function (f, g) 
          {
            ...
            if(! e)
              return;
            a.add(e, g.origType + "." + c.livekey, g.origHandler, g.data), 
            $.inArray(e, d) < 0 && d.push(e);
          })), 
        ...
        hijack : (function (b, d, e, f, g) 
        {
          ...
          i = d.indexOf("drop") ? "drag" : "drop", 
          j, 
          k = f || 0, 
          l, 
          m, 
          n, 
          o = isNaN(f) ? e.interactions.length : f;
          ...
          do
            if(l = e.interactions[k])
            {
              ...
              {
                n.target = g, j = g ? a.handle.call(g, b, n) : null, 
                j === ! 1 ? (i == "drag" && (l.cancelled = ! 0, e.propagates -= 1), 
                d == "drop" && (l[i][f] = null)) : d == "dropinit" && l.droppable.push(c.element(j) || g), 
                d == "dragstart" && (l.proxy = $(c.element(j) || l.drag)[0]), 
                l.results.push(j), 
                delete b.result;
                if(d !== "dropinit")
                  return j;
              })), 
              e.results[k] = c.flatten(l.results), 
              d == "dropinit" && (l.droppable = c.flatten(l.droppable)), 
              d == "dragstart" && ! l.cancelled && n.update();
            }while(++ k < o);
        ...
        {
          var e = d.callback;
          return e.drag = d.drag, e.proxy = d.proxy || d.drag, e.startX = b.pageX, 
          e.startY = b.pageY, 
  ...
  define("app/ui/with_dialog", ["module", "require", "exports", "core/compose", "app/ui/with_scrollbar_width", "app/utils/with_keyboard_modality", "app/utils/is_visible", "app/utils/is_enabled", "app/utils/prevent_next_tooltip", "$lib/jquery.event.drag.js", ], 
  (function (module, require, exports) 
  {
    function withDialog() 
    {
      compose.mixin(this, [withKeyboardModality, withScrollbarWidth, ]), 
      this.defaultAttrs({
      ...
      {
        var a = this.center(this.$dialog), b = $(window).height(), 
        c = $(window).scrollTop();
        this.attr.top != null && (a.top = this.attr.top), this.attr.left != null && (a.left = this.attr.left), 
        this.attr.maxTop != null && (a.top = Math.min(a.top, this.attr.maxTop)), 
        this.attr.maxLeft != null && (a.left = Math.min(a.left, this.attr.maxLeft)), 
      ...
      this.setInitialFocus = (function () 
      {
        ...
        a.length || (a = this.$dialog.find(".primary-btn")), 
        a.length && isEnabled(a) && isVisible(a) ? a.focus() : this.focusNextAvailableControl("start", this.$dialog);
      ...
      {
        var a = this.$dialog.find(this.attr.focusableDescendants), 
        b = this.$dialog.find(this.attr.closeButtonSelector);
      ...
      this.open = (function () 
      {
        this.isOpen() || (this.applyARIAAttrs(), this.createFirstLastTabStop(this.$dialog), 
        this.positionCloseButton(), 
        this.openState = ! 0, 
        this.$dialogContainer.fadeIn("fast", this.notifyFadeInComplete.bind(this)), 
        this.calculateScrollbarWidth(), 
        $("body").addClass(this.attr.modalEnabledClass), 
        this.resize(), 
        this.initiallyVisible || this.position(), 
      ...
      this.isOpen = (function () 
      {
        var a = ! ! (this.$dialog && this.$dialog.length && this.$dialogContainer.length), 
        b = window.DEBUG && window.DEBUG.enabled;
      ...
      this.restorePreviousFocus = (function () 
      {
        ...
        if(this.activeEl)
        {
          a = $(this.activeEl).closest(this.attr.dropdownRootNodeSelector), 
          a.length && (this.activeEl = a.find(this.attr.dropdownToggleSelector)[0]);
          try
{            preventNextTooltip(this.activeEl), this.activeEl.focus(), 
            this.activeEl = null;}
          catch(b)
{            }
      ...
      {
        this.removeFirstLastTabStop(this.$dialog), $(this.attr.modalContainerSelector + ":visible").length || $("body").removeClass(this.attr.modalEnabledClass), 
        this.openState = ! 1, 
        a && this.trigger(this.$dialog, {
          type : "uiDialogRestorePreviousFocus",
          defaultBehavior : "restorePreviousFocus"
        }), 
        this.trigger("uiDialogClosed"), 
        b && this.trigger("uiDialogClosedByRequest");
      }), 
      this.applyARIAAttrs = (function () 
      {
        var a = this.$dialog.closest(this.attr.modalContainerSelector), 
        b = this.$dialog.find(this.attr.modalContentSelector), 
        c = this.$dialog.find(this.attr.modalTitleSelector), 
        d = this.$dialog.find(this.attr.modalBodySelector), 
        e = a.attr("id"), 
        f = e + "-dialog", 
        g = this.$dialog.find(this.attr.closeButtonSelector);
        this.$dialog.attr("id", f), g.attr("aria-controls", f);
        var h = e + "-header";
        c.attr("id", h);
        var i = ! ! d.find(this.attr.formControlsSelector).length, 
        j = i ? "dialog" : "alertdialog", 
        k = {
          role : j,
          "aria-labelledby" : h
        }, 
        l;
        i || (l = e + "-body", d.attr("id", l), k["aria-describedby"] = l, 
        g.attr("aria-describedby", l)), 
        this.$dialog.attr(k), 
        b.attr("role", "document");
      }), 
      ...
      this.after("initialize", (function () 
      {
        ...
        a || (this.$dialog = this.$dialogContainer.find(this.attr.modalSelector)), 
        this.on("click", {
        ...
        this.on(document, "uiShortcutEsc uiCloseDialog", this.close), 
        ...
        ! a && this.$dialogContainer.is(":visible") && (this.initiallyVisible = ! 0, this.open());
      }));
    }
    var compose = require("core/compose"), withScrollbarWidth = require("app/ui/with_scrollbar_width"), 
    withKeyboardModality = require("app/utils/with_keyboard_modality"), 
    isVisible = require("app/utils/is_visible"), 
    isEnabled = require("app/utils/is_enabled"), 
    preventNextTooltip = require("app/utils/prevent_next_tooltip");
    require("$lib/jquery.event.drag.js"), module.exports = withDialog;
  }));
  define("app/ui/dialogs/signup_dialog", ["module", "require", "exports", "core/component", "app/ui/with_dialog", ], 
  (function (module, require, exports) 
  {
    function signupDialog() 
    {
      ...
      this.after("initialize", (function () 
      {
        ...
        this.on(document, "uiOpenSigninOrSignupDialog", this.open), 
        this.on(document, "uiCloseSigninOrSignupDialog", this.close), 
  ...
  define("app/ui/signup_call_out", ["module", "require", "exports", "core/component", ], 
  (function (module, require, exports) 
  {
  ...
  define("app/data/signup_click_scribe", ["module", "require", "exports", "core/component", "app/data/with_scribe", ], 
  (function (module, require, exports) 
  {
    function loggedOutScribe() 
    {
      ...
      this.after("initialize", (function () 
      {
        this.on("uiSignupButtonClicked", this.scribeSignupClick), 
  ...
  define("app/ui/front_page_photo_set", ["module", "require", "exports", "core/component", "core/clock", ], 
  (function (module, require, exports) 
  {
    function expPhotoSet() 
    {
      ...
      {
        var a = this.select("activeCompanionTweetSelector"), b = this.$companionTweets.index(a), 
        c = ++ b % this.companionTweetsLen, 
        d = this.$companionTweets.eq(c);
      ...
      this.after("initialize", (function () 
      {
        ...
        if(this.$companionTweets.length <= 1)
          return;
        clock.setIntervalEvent("uiFrontPagePhotoSetBackgroundTick", this.attr.rotationMs), 
  ...
  define("app/boot/logged_out", ["module", "require", "exports", "app/ui/dialogs/signup_dialog", "app/ui/signup_call_out", "app/data/signup_click_scribe", "app/ui/front_page_photo_set", ], 
  (function (module, require, exports) 
  {
    var SignupDialog = require("app/ui/dialogs/signup_dialog"), 
    SignupCallOut = require("app/ui/signup_call_out"), 
    LoggedOutScribe = require("app/data/signup_click_scribe"), 
    ExpPhotoSet = require("app/ui/front_page_photo_set");
    module.exports = (function (b) 
    {
      ...
      b.inExpPhotoSet && ExpPhotoSet.attachTo("#page-container");
    });
  }));
  define("app/utils/ttft", ["module", "require", "exports", "app/data/scribe_transport", "app/utils/params", ], 
  (function (module, require, exports) 
  {
    function scribeTTFTData(a, b) 
    {
      if(! recorded && window.performance && a)
      {
        ...
        c.web_timings.toJSON && delete c.web_timings.toJSON, 
        c.navigation = {
          type : window.performance.navigation.type,
          redirectCount : window.performance.navigation.redirectCount
        }, 
        c.referrer = document.referrer, 
        scribeTransport.send(c, "swift_time_to_first_tweet", ! 1);
...
{          window.ttft = undefined;}
    ...
    {
      c && c.url && (newAjaxRequests[c.url] || (newAjaxRequests[c.url] = []), 
      newAjaxRequests[c.url].push(c));
    }
    ...
    {
      startingAjaxCount = pendingAjaxCount = $.active, recordMilestone("ajax_count", startingAjaxCount), 
      startingAjaxCount == 0 ? recordPendingAjaxComplete() : (unbindAjaxHandlers(), bindAjaxHandlers());
    }
    function recordMilestone(a, b) 
    {
      window.ttftData && ! window.ttftData[a] && (window.ttftData[a] = b), 
      scribeMilestones(! 1);
    }
    var scribeTransport = require("app/data/scribe_transport"), 
    params = require("app/utils/params"), 
    recorded = ! 1, 
    requiredMilestones = ["page", "client_record_time", "aq_empty_time", "ajax_complete_time", "ajax_count", ], 
    startingAjaxCount = 0, 
    pendingAjaxCount = 0, 
    newAjaxRequests = {
  ...
  using("debug/debug", (function (a) 
  {
        ...
        if(window.swiftActionQueue)
        {
          ...
          if(c.deciders)
            if(c.deciders.scribeReducedActionQueue)
              ...
              if(c.deciders.scribeActionQueue)
                for(var f in e.buckets)
                  $(document).trigger("scribe", {
                    scribeEvent : {
    ...
    location.search.match(/debug=1/) && $("body").addClass("debug");
    if($("body").hasClass("debug"))
    {
      ...
      $(document).on("scribedata.ScribeTransport", (function (a, b) 
      {
        ...
        {
          var d = [c.client, c.page, c.section, c.component, c.element, c.action, ].join(":");
