  ...
  (function () 
  {
    if(! Array.prototype.find)
      Array.prototype.find = (function (a, b) 
      {
        ...
        var c = Object(this), d = c.length >>> 0, e;
        for(var f = 0;f < d;f ++)
          if(f in c)
          {
            e = c[f];
  ...
  (function () 
  {
    ...
    if(! Array.prototype.map)
      Array.prototype.map = (function (e, f) 
      {
        ...
        for(g = 0;g < h;++ g)
          if(g in this)
            i[g] = e.call(f, this[g], g, this);
        return i;
      });
    if(! Array.prototype.forEach)
      Array.prototype.forEach = (function (e, f) 
      {
        this.map(e, f);
      });
    if(! Array.prototype.filter)
      Array.prototype.filter = (function (e, f) 
      {
        ...
        for(g = 0;g < i;++ g)
          ...
          {
            h = this[g];
            if(e.call(f, h, g, this))
              j.push(h);
          }
        return j;
      });
    if(! Array.prototype.every)
      Array.prototype.every = (function (e, f) 
      {
        if(typeof e != 'function')
          throw new TypeError();
  ...
  (function () 
  {
    ...
    if(! a)
      return;
    var b = ['toString', 'toLocaleString', 'valueOf', 'hasOwnProperty', 'isPrototypeOf', 'prototypeIsEnumerable', 'constructor', ];
    Object.keys = (function (c) 
    {
      var d = typeof c;
      if((d != 'object' && d != 'function') || c === null)
        throw new TypeError('Object.keys called on non-object');
    ...
    Object.assign = (function (c, d) 
    {
      ...
      var e = Object(c), f = Object.prototype.hasOwnProperty;
  ...
  if({
    ...
    Object.prototype.hasOwnProperty = (function (a) 
    {
      return (function b(c) 
      {
        return c != '__proto__' && a.call(this, c);
      });
  ...
  (function (a) 
  {
    ...
    function j(y) 
    {
      var z = Array.prototype.slice.call(y), aa = {
    ...
    function q(y) 
    {
      ...
      if(z.hasError)
        throw new k('Requiring module "' + y + '" which threw an exception');
      if(z.waiting)
        throw new k('Requiring module "' + y + '" with unresolved dependencies: ' + j([y, ]));
      var da = z.exports = {
      ...
      if(b.call(ea) === '[object Function]')
      {
        ...
        if(z.special & h)
          ha = Math.min(ha, ea.length);
        try
{          for(ba = 0;fa.length < ha;ba ++)
          {
            aa = ga[ba];
            if(! z.inlineRequires[aa])
              fa.push(aa === 'module' ? z : (aa === 'exports' ? da : q.call(null, aa)));
          }
          ++ p;
          if(n ++ === 0)
            o -= m();
        ...
        if(! c[ba])
        {
          ...
          if(c[ba].waiting)
            for(da in c[ba].waitingMap)
              if(c[ba].waitingMap[da])
                v(aa, da);
      }
      if(aa.waiting === 0 && aa.special & g)
        z.push(y);
      if(d[y])
      {
        var ea = d[y], fa;
...
{        return ['erx parse failure: %s', i, ];}
  ...
  null);
  __d("ErrorUtils", ["Env", "eprintf", "erx", "wrapFunction", ], 
  (function (a, b, c, d, e, f, g, h, i, j) 
  {
    var k = {
      
    }, l = '<anonymous guard>', m = '<generated guard>', 
    n = '<window.onerror>', 
    o = /^https?:\/\//i, 
    p = /^Type Mismatch for/, 
...
{        var ta = aa(sa);
        if(oa)
          oa(ta);
        if(la)
          ta.callee = la.toString().substring(0, 100);
        if(na)
          ta.args = Array.prototype.slice.call(na).toString().substring(0, 100);
        ta.guard = w[0];
...
{        ea();}
  ...
  null);
  __d("EventEmitter", ["EmitterSubscription", "ErrorUtils", "EventSubscriptionVendor", "emptyFunction", "invariant", ], 
      ...
      if(n)
      {
        ...
        for(var p = 0;p < o.length;p ++)
        {
          ...
          if(r)
          {
            ...
            h.applyWithGuard(r.listener, r.context, Array.prototype.slice.call(arguments, 1), 
            null, 
            'EventEmitter:' + m);
          }
        }
...
{          }
  ...
  null);
  __d("Arbiter", ["CallbackDependencyManager", "ErrorUtils", "EventEmitter", "EventEmitterWithHolding", "EventHolder", "asyncCallback", "copyProperties", "createArrayFrom", "invariant", ], 
  ...
  {
    var i = "arbiter$" + h(), j = Object.prototype.hasOwnProperty, 
    k = {
  ...
  __d("$", ["ex", ], (function (a, b, c, d, e, f, g) 
  {
    function h(j) 
    {
      ...
      if(! k)
        throw new Error(g('Tried to get element with id of "%s" but it is not present on the page.', 
        j));
      return k;
    }
    function i(j) 
  ...
  null);
  __d("Run", ["Arbiter", "OnloadEvent", ], (function (a, b, c, d, e, f, g, h) 
  {
    var i = 'onunloadhooks', j = 'onafterunloadhooks', k = g.BEHAVIOR_STATE;
    function l(ba) 
    {
  ...
  __d("UserAgent_DEPRECATED", [], (function (a, b, c, d, e, f) 
  {
    ...
    function w() 
    {
      if(g)
        return;
      g = true;
      var y = navigator.userAgent, z = /(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(y), 
  ...
  null);
  __d("CurrentCommunity", ["CurrentCommunityInitialData", ], 
  ...
  null);
  __d("ServerJSDefine", ["BitMap", "replaceTransportMarkers", ], 
  (function (a, b, c, d, e, f, g, h) 
  {
    var i = new g(), j = {
  ...
  null);
  __d("URIBase", ["URIRFC3986", "URISchemes", "copyProperties", "ex", "invariant", ], 
  (function (a, b, c, d, e, f, g, h, i, j, k) 
  {
...
{          return false;}
      ...
      if(t.fragment === '')
        p.setForceFragmentSeparator(true);
      if(t.userinfo !== null)
        if(r)
        {
          throw new Error(j('URI.parse: invalid URI (userinfo is not allowed in a URI): %s', 
          p.toString()));
        }
        else
          return false;
      if(! p.getDomain() && p.getPath().indexOf('\\') !== - 1)
        if(r)
        {
          throw new Error(j('URI.parse: invalid URI (no domain but multiple back-slashes): %s', 
          p.toString()));
        }
        else
          return false;
      if(! p.getProtocol() && m.test(q))
        if(r)
        {
          throw new Error(j('URI.parse: invalid URI (unsafe protocol-relative URLs): %s', 
          p.toString()));
        }
        else
          return false;
    ...
    "use strict";
      if(l.test(p))
        throw new Error(j('URI.setDomain: unsafe domain specified: %s for url %s', 
        p, 
        this.toString()));
      this.$URIBase2 = p;
      return this;
  ...
  __d("PHPQuerySerializer", ["invariant", ], (function (a, b, c, d, e, f, g) 
  {
    ...
    function l(o) 
    {
      ...
      for(var r = 0, s = o.length;r < s;r ++)
      {
        ...
        {
          var v = t[2].split(/\]\[|\[|\]/).slice(0, - 1), w = t[1], 
          x = m(t[3] || '');
          v[0] = w;
          var y = p;
  ...
  null);
  __d("getAsyncParams", ["CurrentCommunity", "CurrentUser", "DTSG", "ISB", "LSD", "ServerJSDefine", "SiteData", "URIBase", "PHPQuerySerializer", ], 
  (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) 
  {
    var p = 1;
    function q(r) 
...
{        throw new Error(g('getSameOriginTransport: %s', i.message));}
  ...
  null);
  __d("BanzaiAdapter", ["Arbiter", "CurrentUser", "Miny", "QueryString", "Run", "SiteData", "UserAgent_DEPRECATED", "getAsyncParams", "getSameOriginTransport", "setTimeoutAcrossTransitions", "BanzaiConfig", ], 
  (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) 
  {
    var r = [], s = new g(), t = '/ajax/bz', u = {
...
{        var v = n(q).map((function (w) 
        ...
        t = new Error(h('Storage quota exceeded while setting %s(%s). Items(length) follows: %s', 
        r, 
        s.length, 
        v.join()));
        g.reportError(t);}
  ...
  null);
  __d("WebStorageMutex", ["WebStorage", "setTimeoutAcrossTransitions", "pageID", ], 
  (function (a, b, c, d, e, f, g, h, i) 
  {
  ...
  null);
  __d("Banzai", ["BanzaiAdapter", "CurrentUser", "ErrorUtils", "ExecutionEnvironment", "FBJSON", "WebStorage", "WebStorageMutex", "emptyFunction", "isInIframe", "pageID", "setTimeoutAcrossTransitions", ], 
  (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) 
  {
    var r = g.adapter, s = o(), t = 'bz:', u = 0, v = 1, w = 2, 
    x, 
    y, 
    z = [], 
    aa = null;
...
{          na = null;}
  ...
  null);
  __d("CSSLoader", ["isEmpty", "setIntervalAcrossTransitions", ], 
  (function (a, b, c, d, e, f, g, h) 
  {
    var i = 20, j = 5000, k, l, m = {
...
{              y();
    ...
    var la = {
      ...
      loadComponents : (function (ma, na) 
      {
        ...
        for(var pa = 0;pa < ma.length;pa ++)
        {
          ...
          {
            if(qa)
              ca(m('%s has a conflicting legacy component. That cannot happen ' + 'and legacy won btw.', 
              ma[pa]));
            ma[pa] = ra;
            oa.push(ra);
            continue;
  ...
  null);
  __d("ServerJS", ["ErrorUtils", "EventEmitter", "ServerJSDefine", "copyProperties", "ex", "ge", "replaceTransportMarkers", ], 
  (function (a, b, c, d, e, f, g, h, i, j, k, l, m) 
  {
    var n = 0, o = new h(), p = 0;
    function q() 
    ...
    j(q.prototype, {
      ...
      cleanup : (function () 
      {
        ...
        for(var x in this._moduleIDsToCleanup)
          g.applyWithGuard(w, this, [x, ], null, 'ServerJS:cleanup' + ' id: ' + x);
      }),
      ...
      _handleRequire : (function (u, v, w, x) 
      {
        return g.applyWithGuard((function () 
        {
          ...
          return define(z, y, g.guard((function (aa) 
          {
            ...
            {
              if(! aa[v])
                throw new TypeError(k('Module %s has no method "%s"', u, v));
              var ba = {
                moduleName : u,
                method : v,
          ...
          v ? "JS::call('" + u + "', '" + v + "', ...)" : "JS::requireModule('" + u + "')"), 
          1, 
          this, 
          1);
        }), 
      ...
      'JS::instance'),
      _handleMarkup : g.guard((function (u, v, w) 
      {
      ...
      'JS::markup'),
      _handleElement : g.guard((function (u, v, w, x) 
      {
        if(v === null && w)
        {
  ...
  t) 
  {
    var u = document.documentMode || + (/MSIE.(\d+)/.exec(navigator.userAgent) || [])[1], 
    v = g.BEHAVIOR_STATE, 
...
{      }
  ...
  null);
  __d("Primer", ["Bootloader", "CSS", "ErrorUtils", "Parent", "clickRefAction", "trackReferrer", "userAction", ], 
  (function (a, b, c, d, e, f, g, h, i, j, k, l, m) 
  {
    var n = null, o = /async(?:-post)?|dialog(?:-post)?|theater|toggle/, 
  ...
  null);
  __d("CommentPrelude", ["Arbiter", "CSS", "Parent", "clickRefAction", "userAction", ], 
  (function (a, b, c, d, e, f, g, h, i, j, k) 
  {
    function l(p, q) 
    {
        ...
        g = new i((function (j) 
        {
          for(var k = 0;k < j.length;k ++)
          {
            ...
            if(l.type == 'childList')
            {
              ...
              if(l.type == 'attributes' && l.attributeName == 'src' && (l.target.tagName == 'SCRIPT' || l.target.tagName == 'IFRAME'))
                h.push(l.target.src);
          }
        }));
        g.observe(document, {
