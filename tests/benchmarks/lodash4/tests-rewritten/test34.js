...
(function () {
    ...
    QUnit.test('should allow specifying `arity`', function (assert) {
        assert.expect(3);
        var curried = _.curry(fn, __num_top__), expected = [
                __num_top__,
                __num_top__,
                __num_top__
            ];
    ...
    QUnit.test('should coerce `arity` to an integer', function (assert) {
        ...
        assert.deepEqual(_.curry(fn, __str_top__)(__num_top__)(__num_top__), [
            __num_top__,
            __num_top__
        ]);
    });
    QUnit.test('should support placeholders', function (assert) {
        ...
        assert.deepEqual(curried(__num_top__)(ph, __num_top__)(ph, __num_top__)(__num_top__), [
            __num_top__,
            __num_top__,
            __num_top__,
            __num_top__
        ]);
        assert.deepEqual(curried(ph, __num_top__)(__num_top__)(ph, __num_top__)(__num_top__), [
            __num_top__,
            __num_top__,
            __num_top__,
            __num_top__
        ]);
        assert.deepEqual(curried(ph, ph, __num_top__)(ph, __num_top__)(ph, __num_top__)(__num_top__), [
            __num_top__,
            __num_top__,
            __num_top__,
            __num_top__
        ]);
        assert.deepEqual(curried(ph, ph, ph, __num_top__)(ph, ph, __num_top__)(ph, __num_top__)(__num_top__), [
            __num_top__,
            __num_top__,
            __num_top__,
            __num_top__
    ...
    QUnit.test('should persist placeholders', function (assert) {
        assert.expect(1);
        var curried = _.curry(fn), ph = curried.placeholder, actual = curried(ph, ph, ph, __str_top__)(__str_top__)(ph)(__str_top__)(__str_top__);
    ...
    QUnit.test('should use `_.placeholder` when set', function (assert) {
        ...
        if (!isModularize) {
            ...
            assert.deepEqual(curried(__num_top__)(_ph, __num_top__)(ph, __num_top__), [
                __num_top__,
                ph,
                __num_top__,
                __num_top__
    ...
    QUnit.test('should provide additional arguments after reaching the target arity', function (assert) {
        assert.expect(3);
        var curried = _.curry(fn, __num_top__);
    ...
    QUnit.test('should create a function with a `length` of `0`', function (assert) {
        ...
        lodashStable.times(__num_top__, function (index) {
            var curried = index ? _.curry(fn, __num_top__) : _.curry(fn);
    ...
    QUnit.test('should use `this` binding of function', function (assert) {
        ...
        assert.deepEqual(_.curry(_.bind(fn, object), __num_top__)(__str_top__)(__str_top__)(__str_top__), expected);
        assert.deepEqual(_.curry(_.bind(fn, object), __num_top__)(__str_top__, __str_top__)(__str_top__), expected);
        assert.deepEqual(_.curry(_.bind(fn, object), __num_top__)(__str_top__, __str_top__, __str_top__), expected);
        assert.deepEqual(_.bind(_.curry(fn), object)(__str_top__)(__str_top__)(__str_top__), Array(__num_top__));
        assert.deepEqual(_.bind(_.curry(fn), object)(__str_top__, __str_top__)(__str_top__), Array(__num_top__));
        assert.deepEqual(_.bind(_.curry(fn), object)(__str_top__, __str_top__, __str_top__), expected);
    ...
    QUnit.test('should work with partialed methods', function (assert) {
        ...
        var a = _.partial(curried, __num_top__), b = _.bind(a, null, __num_top__), c = _.partialRight(b, __num_top__), d = _.partialRight(b(__num_top__), __num_top__);
