...
(function () {
    QUnit.test('should work with an `end`', function (assert) {
        assert.expect(3);
        assert.strictEqual(_.inRange(3, 5), __bool_top__);
        assert.strictEqual(_.inRange(5, 5), false);
        assert.strictEqual(_.inRange(6, __num_top__), false);
    });
    ...
    QUnit.test('should work with a floating point `n` value', function (assert) {
        ...
        assert.strictEqual(_.inRange(5.2, __num_top__), false);
