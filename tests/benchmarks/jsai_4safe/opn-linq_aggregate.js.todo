...
{
    actual = Enumerable.Range(1, 10).Aggregate(function(a,b) { return a+b; });
    print(actual);
    equal(actual, 55);

    actual = Enumerable.Range(1, 10).Aggregate(10, function(a,b) { return a+b; });
    print(actual);
    equal(actual, 65);

    actual = Enumerable.Range(1, 10).Aggregate(10, function(a,b) {return a+b;}, function(val) { return val*10; });
    print(actual);
    equal(actual, 650);
});
...
test("Average", function ()
{
    ...
    actual = Enumerable.Range(1, 10).Select(function(v,i) {return {v:v,i:i}; }).Average(function(t) { return t.i; });
    print(actual);
    equal(actual, 4.5);
});
...
test("Count", function ()
{
    ...
    actual = Enumerable.Range(1, 10).Count(function(i) { return i<5;} );
    print(actual);
    equal(actual, 4);
});
...
test("Max", function ()
{
    ...
    actual = Enumerable.Range(1, 10).Select(function(v,i) {return {v:v,i:i};}).Max(function(t) { return t.i});
    print(actual);
    equal(actual, 9);
});
...
test("Min", function ()
{
    ...
    actual = Enumerable.Range(1, 10).Select(function(v,i) { return {v:v,i:i}}).Min(function(t) {return t.i});
    print(actual);
    equal(actual, 0);
});
...
test("MaxBy", function ()
{
    actual = Enumerable.Range(1, 10).Select(function(v,i) {return {v:v,i:i}}).MaxBy(function(t) {return t.i});
    print(actual.v);
    print(actual.i);
...
test("MinBy", function ()
{
    actual = Enumerable.Range(1, 10).Select(function(v,i) { return {v:v,i:i}}).MinBy(function(t) { return t.i});
    print(actual.v);
    print(actual.i);
...
test("Sum", function ()
{
    ...
    actual = Enumerable.Range(1, 10).Select(function(v,i) { return {v:v,i:i}}).Sum(function(t) { return t.i});
    print(actual);
    equal(actual, 45);
});
