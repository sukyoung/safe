...
test("AddGetCountRemoveClear", function ()
{
    ...
    dict.Add("c", 3);
    dict.Add("c", 100);
    var result1 = dict.Get("a");
    print(result1);
    var result2 = dict.Get("b");
    print(result2);
    var result3 = dict.Get("c");
    print(result3);
    equal(1, dict.Get("a"));
    equal(2, dict.Get("b"));
    ...
    dict.Add(obj2, 3);
    dict.Add(obj2_, 4);
    var result4 = dict.Get(obj1);
    print(result4);
    var result5 = dict.Get(obj1_);
    print(result5);
    var result6 = dict.Get(obj2);
    print(result6);
    var result7 = dict.Get(obj2_);
    print(result7);
    ...
    var result9 = dict.Count();
    print(result9);
    equal(3, dict.Count());
    dict.Clear();
    equal(undefined, dict.Get("b"));
    equal(undefined, dict.Get(obj2));
    var result10 = dict.Count();
    print(result10);

    equal(0, dict.Count());

    dict = Enumerable.Empty().ToDictionary(false, false, aComparer);
...
test("ToEnumerable", function ()
{
    ...
    var ar = dict.ToEnumerable().OrderBy(function(x) { return x.Key; }).ToArray();
    equal("a", ar[0].Key);
    equal(1, ar[0].Value);
    equal("b", ar[1].Key);
    equal(2, ar[1].Value);
    equal("c", ar[2].Key);
    var result1 = ar[2].Key;
    print(result1);
    equal(3, ar[2].Value);
    ...
    ar = dict.ToEnumerable().OrderBy(function(x) { return x.Key.a; }).ToArray();
    equal(obj1, ar[0].Key);
    equal(1, ar[0].Value);
