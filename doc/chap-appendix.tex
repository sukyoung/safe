...
% \emph{createFunction} \ : \\
% \ \ \String \times \CFGId^{*} \times \CFGId^{*} \times \String \rightarrow \CFGFunction \\
% \emph{addEdge} \ : \\
% \ \ \powerset{\CFGBlock} \times \powerset{\CFGBlock} \times \EdgeType \rightarrow \Unit \\
% \end{Bmatrix*}
% \\\\
\begin{array}{@{~}r@{~}l@{}l@{~}l}
\new & \CFG & : & \CFGId^{*} \rightarrow \CFG \\
...
\subsubsection{$\CFGFunction$ Methods}
\[
\begin{array}{l@{}l@{~}l}
...
\subsubsection{$\CFGBlock$ Methods}
\[
\begin{array}{l@{}l@{~}l}
