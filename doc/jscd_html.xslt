                                ...
                                <td style="word-wrap:break-word; max-width:600px;" valign="top">
                                    <p>
                                        <a>
                                            <xsl:attribute name="href">
                                                <xsl:value-of select="@file" />.html#line<xsl:value-of select="@lineno" /></xsl:attribute>
                                            <xsl:value-of select="@file" />
                                        </a>
                                    </p>
                                    <p>line <xsl:value-of select="@lineno" />-<xsl:value-of select="@lineno+@lineoffset+(-1)" /></p>
                                    <p># lines : <xsl:value-of select="@lineoffset" /></p>
                                    ...
                                    <div style="display:none;">
                                        <xsl:attribute name="id">
                                            <xsl:value-of select="../@id" />_<xsl:value-of select="position()" />_<xsl:value-of select="@index" />_<xsl:value-of select="@lineno" />_<xsl:value-of select="@lineoffset" /></xsl:attribute>
                                    </div>
                                </td>
                            </xsl:for-each>
                        </tr>
