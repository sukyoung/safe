...
\newcommand{\tsf}[1]{\mbox{\scriptsize{\textsf{#1}}}\xspace}
\newcommand{\SF}[1]{\mbox{\textsf{#1}}\xspace}
\newcommand{\RM}[1]{\mbox{\textrm{#1}}\xspace}
\newcommand{\TT}[1]{\mbox{\texttt{#1}}\xspace}
\newcommand{\Command}{\SF{Command}}
\newcommand{\JSLabel}{\SF{JSLabel}}
\newcommand{\RetLabel}{\TT{RetLabel}}
\newcommand{\ThrowLabel}{\TT{ThrowLabel}}
\newcommand{\ThrowEndLabel}{\TT{ThrowEndLabel}}
\newcommand{\AfterCatchLabel}{\TT{AfterCatchLabel}}
\newcommand{\UserLabel}{\SF{UserLabel}}
\newcommand{\IRNode}{\SF{IRNode}}
\newcommand{\IRRoot}{\SF{IRRoot}}
\newcommand{\IRVarStmt}{\SF{IRVarStmt}}
\newcommand{\IRStmt}{\SF{IRStmt}}
\newcommand{\IRFunctional}{\SF{IRFunctional}}
\newcommand{\IRFunDecl}{\SF{IRFunDecl}}
\newcommand{\IRField}{\SF{IRField}}
\newcommand{\IRExpr}{\SF{IRExpr}}
\newcommand{\IRId}{\SF{IRId}}

\newcommand{\CFG}{\ensuremath{\SF{CFG}}\xspace}
\newcommand{\CFGFunction}{\SF{CFGFunction}}
\newcommand{\CFGBlock}{\SF{CFGBlock}}
\newcommand{\Entry}{\SF{Entry}}
\newcommand{\Exit}{\SF{Exit}}
\newcommand{\ExitExc}{\SF{ExitExc}}
\newcommand{\Call}{\SF{Call}}
\newcommand{\AfterCall}{\SF{AfterCall}}
\newcommand{\AfterCatch}{\SF{AfterCatch}}
\newcommand{\entry}{\TT{entry}}
\newcommand{\exit}{\TT{exit}}
\newcommand{\exitExc}{\TT{exitExc}}
\newcommand{\call}{\TT{call}}
\newcommand{\acall}{\TT{acall}}
\newcommand{\acatch}{\TT{acatch}}
\newcommand{\NormalBlock}{\SF{NormalBlock}}
\newcommand{\ModelBlock}{\SF{ModelBlock}}
\newcommand{\CFGEdge}{\SF{CFGEdge}}
\newcommand{\EdgeType}{\SF{EdgeType}}
\newcommand{\EdgeNormal}{\TT{EdgeNormal}}
\newcommand{\EdgeExc}{\TT{EdgeExc}}
\newcommand{\CFGCallTriple}{\SF{CFGCallTriple}}
\newcommand{\CFGInst}{\SF{CFGInst}}
\newcommand{\CFGNormalInst}{\SF{CFGNormalInst}}
\newcommand{\CFGCallInst}{\SF{CFGCallInst}}
\newcommand{\CFGExpr}{\SF{CFGExpr}}
\newcommand{\CFGId}{\SF{CFGId}}
\newcommand{\VarKind}{\SF{VarKind}}
\newcommand{\Binop}{\SF{Binop}}
\newcommand{\Unop}{\SF{Unop}}
\newcommand{\Any}{\SF{Any}}
\newcommand{\String}{\SF{String}}
\newcommand{\Address}{\SF{Address}}
\newcommand{\Number}{\SF{Number}}
\newcommand{\Integer}{\SF{Integer}}
\newcommand{\Unit}{\SF{Unit}}
\newcommand{\Nil}{\SF{Nil}}
\newcommand{\this}{\SF{this}}
\newcommand{\LabelMap}{\SF{LabelMap}}
...
\newcommand{\aContext}{\abs{Context}}
\newcommand{\aLoc}{\abs{Loc}}
\newcommand{\aAddress}{\abs{Address}}
...
\newcommand{\aC}{\hat{\mathcal{C}}}
\newcommand{\aB}{\hat{\mathcal{B}}}
\newcommand{\aI}{\hat{\mathcal{I}}}
\newcommand{\aCI}{\hat{\mathcal{CI}}}
...
\newcommand{\blocks}{\mathbb{B}}
\newcommand{\cps}{\mathbb{C}}
...
\newcommand{\irfunctionalsmall}[7]{
	\begin{smallmatrix}
	\textsf{IRFunctional}(#1, #2, #3, \\
	#4, #5, #6, #7)
	\end{smallmatrix}}
