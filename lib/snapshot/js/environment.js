...
(function(){
	...
	//var instMember = ['__mk_lex_obj', '__check_scope', '__dec_lex', '__st_lex', '__ld_lex', '__newFid', '__funcNum', '__fid', '__span', '__loc', '__dump', '_outscope','__addLoadEvent','__JSED','__event_info','__lexicals','__real_add_event_fun','__real_remove_event_fun', '__printed', '__bind_info', '__interval_info', '__timeout_info', '__real_bind_fun', '__real_interval_fun', '__real_clearInt_fun', '__real_timeout_fun', '__real_clearTim_fun', '__silentAddEventListener', '__real_add_eve_fun', '__real_remove_eve_fun', '__global_except','@loc','@printed'];
	...
	//var notModelList = [Number.parseFloat, Number.parseInt, Object.prototype.__defineGetter__, Object.prototype.__lookupGetter__, Object.prototype.__defineSetter__, Object.prototype.__lookupSetter__, Navigator.prototype.getBettery, Document.prototype.getElementsByClassName, Navigator.prototype.sendBeacon, Array.prototype.entries, Array.prototype.keys, CharacterData.prototype.remove, DOMImplementation.prototype.createHTMLDocument, Array.prototype.entries, Array.prototype.keys, CharacterData.prototype.remove, DOMImplementation.prototype.createHTMLDocument, Document.prototype.caretRangeFromPoint, Document.prototype.createEvent, Document.prototype.createExpression, Document.prototype.createNSResolver, Document.prototype.createNodeIterator, Document.prototype.createRange, Document.prototype.createTreeWalker, Document.prototype.elementFromPoint, Document.prototype.evaluate, Document.prototype.execCommand, Document.prototype.exitPointerLock, Document.prototype.getCSSCanvasContext, Document.prototype.getElementsByName, Document.prototype.getOverrideStyle, Document.prototype.getSelection, Document.prototype.hasFocus, Document.prototype.queryCommandEnabled, Document.prototype.queryCommandIndeterm, Document.prototype.queryCommandState, Document.prototype.queryCommandSupported, Document.prototype.queryCommandValue, Document.prototype.registerElement, Document.prototype.webkitCancelFullScreen, Document.prototype.webkitExitFullscreen, Element.prototype.animate, Element.prototype.blur, Element.prototype.createShadowRoot, Element.prototype.focus, Element.prototype.getDestinationInsertionPoints, Element.prototype.hasAttributes, Element.prototype.insertAdjacentElement, Element.prototype.insertAdjacentHTML, Element.prototype.insertAdjacentText, Element.prototype.matches, Element.prototype.remove, Element.prototype.requestPointerLock, Element.prototype.scrollIntoViewIfNeeded, Element.prototype.webkitRequestFullScreen, HTMLButtonElement.prototype.checkValidity, HTMLButtonElement.prototype.reportValidity, HTMLButtonElement.prototype.setCustomValidity, HTMLDocument.prototype.captureEvents, HTMLDocument.prototype.clear, HTMLDocument.prototype.releaseEvents, HTMLElement.prototype.click, NamedNodeMap.prototype.item, Navigator.prototype.getBattery, Navigator.prototype.getGamepads, Navigator.prototype.getStorageUpdates, Navigator.prototype.sendBeacon, Navigator.prototype.vibrate, Navigator.prototype.webkitGetGamepads, Navigator.prototype.webkitGetUserMedia, RegExp.prototype.compile, String.prototype.anchor, String.prototype.big, String.prototype.blink, String.prototype.bold, String.prototype.fixed, String.prototype.fontcolor, String.prototype.fontsize, String.prototype.italics, String.prototype.link, String.prototype.normalize, String.prototype.small, String.prototype.strike, String.prototype.sub, String.prototype.sup, String.prototype.trimLeft, String.prototype.trimRight, Text.prototype.getDestinationInsertionPoints, Element.prototype.webkitRequestFullscreen, Math.acosh, Math.asinh, Math.atanh, Math.cbrt, Math.clz32, Math.cosh, Math.expm1, Math.fround, Math.hypot, Math.imul, Math.log10, Math.log1p, Math.log2, Math.sign, Math.sinh, Math.tanh, Math.trunc, Array.observe, Array.unobserve, Attr.toString, CSSStyleSheet.prototype.addRule, CSSStyleSheet.prototype.deleteRule, CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.removeRule, CanvasGradient.prototype.addColorStop, CanvasRenderingContext2D.prototype.arc, CanvasRenderingContext2D.prototype.arcTo, CanvasRenderingContext2D.prototype.beginPath, CanvasRenderingContext2D.prototype.bezierCurveTo, CanvasRenderingContext2D.prototype.clearRect, CanvasRenderingContext2D.prototype.clip, CanvasRenderingContext2D.prototype.closePath, CanvasRenderingContext2D.prototype.createImageData, CanvasRenderingContext2D.prototype.createLinearGradient, CanvasRenderingContext2D.prototype.createPattern, CanvasRenderingContext2D.prototype.createRadialGradient, CanvasRenderingContext2D.prototype.drawFocusIfNeeded, CanvasRenderingContext2D.prototype.drawImage, CanvasRenderingContext2D.prototype.ellipse, CanvasRenderingContext2D.prototype.fill, CanvasRenderingContext2D.prototype.fillRect, CanvasRenderingContext2D.prototype.fillText, CanvasRenderingContext2D.prototype.getContextAttributes, CanvasRenderingContext2D.prototype.getImageData, CanvasRenderingContext2D.prototype.getLineDash, CanvasRenderingContext2D.prototype.isPointInPath, CanvasRenderingContext2D.prototype.isPointInStroke, CanvasRenderingContext2D.prototype.lineTo, CanvasRenderingContext2D.prototype.measureText, CanvasRenderingContext2D.prototype.moveTo, CanvasRenderingContext2D.prototype.putImageData, CanvasRenderingContext2D.prototype.quadraticCurveTo, CanvasRenderingContext2D.prototype.rect, CanvasRenderingContext2D.prototype.resetTransform, CanvasRenderingContext2D.prototype.restore, CanvasRenderingContext2D.prototype.rotate, CanvasRenderingContext2D.prototype.save, CanvasRenderingContext2D.prototype.scale, CanvasRenderingContext2D.prototype.setLineDash, CanvasRenderingContext2D.prototype.setTransform, CanvasRenderingContext2D.prototype.stroke, CanvasRenderingContext2D.prototype.strokeRect, CanvasRenderingContext2D.prototype.strokeText, CanvasRenderingContext2D.prototype.transform, CanvasRenderingContext2D.prototype.translate, DOMException.prototype.toString, Date.prototype.getYear, Date.prototype.setYear, Date.prototype.toGMTString, DocumentFragment.prototype.getElementById, DocumentFragment.prototype.querySelector, DocumentFragment.prototype.querySelectorAll, DocumentType.prototype.remove, Element.prototype.closest, Error.captureStackTrace, Error.prototype.toString, HTMLAnchorElement.prototype.toString, HTMLAreaElement.prototype.toString, HTMLCanvasElement.prototype.getContext, HTMLCanvasElement.prototype.toDataURL, HTMLFieldSetElement.prototype.checkValidity, HTMLFieldSetElement.prototype.reportValidity, HTMLFieldSetElement.prototype.setCustomValidity, HTMLFormElement.prototype.checkValidity, HTMLFormElement.prototype.reportValidity, HTMLFormElement.prototype.requestAutocomplete, HTMLFormElement.prototype.reset, HTMLFormElement.prototype.submit, HTMLFrameElement.prototype.getSVGDocument, HTMLIFrameElement.prototype.getSVGDocument, HTMLInputElement.prototype.checkValidity, HTMLInputElement.prototype.reportValidity, HTMLInputElement.prototype.select, HTMLInputElement.prototype.setCustomValidity, HTMLInputElement.prototype.setRangeText, HTMLInputElement.prototype.setSelectionRange, HTMLInputElement.prototype.stepDown, HTMLInputElement.prototype.stepUp, HTMLObjectElement.prototype.checkValidity, HTMLObjectElement.prototype.getSVGDocument, HTMLObjectElement.prototype.reportValidity, HTMLObjectElement.prototype.setCustomValidity, HTMLOptionsCollection.prototype.add, HTMLOptionsCollection.prototype.namedItem, HTMLOptionsCollection.prototype.remove, HTMLSelectElement.prototype.add, HTMLSelectElement.prototype.checkValidity, HTMLSelectElement.prototype.item, HTMLSelectElement.prototype.namedItem, HTMLSelectElement.prototype.remove, HTMLSelectElement.prototype.reportValidity, HTMLSelectElement.prototype.setCustomValidity, HTMLTableElement.prototype.createCaption, HTMLTableElement.prototype.createTBody, HTMLTableElement.prototype.createTFoot, HTMLTableElement.prototype.createTHead, HTMLTableElement.prototype.deleteCaption, HTMLTableElement.prototype.deleteRow, HTMLTableElement.prototype.deleteTFoot, HTMLTableElement.prototype.deleteTHead, HTMLTableElement.prototype.insertRow, HTMLTableRowElement.prototype.deleteCell, HTMLTableRowElement.prototype.insertCell, HTMLTableSectionElement.prototype.deleteRow, HTMLTableSectionElement.prototype.insertRow, HTMLTextAreaElement.prototype.checkValidity, HTMLTextAreaElement.prototype.reportValidity, HTMLTextAreaElement.prototype.select, HTMLTextAreaElement.prototype.setCustomValidity, HTMLTextAreaElement.prototype.setRangeText, HTMLTextAreaElement.prototype.setSelectionRange, KeyboardEvent.prototype.getModifierState, KeyboardEvent.prototype.initKeyboardEvent, MessageEvent.prototype.initMessageEvent, MouseEvent.prototype.initMouseEvent, MutationEvent.prototype.initMutationEvent, Number.isFinite, Number.isInteger, Number.isNaN, Number.isSafeInteger, Object.deliverChangeRecords, Object.getNotifier, Object.getOwnPropertySymbols, Object.is, Object.observe, Object.setPrototypeOf, Object.unobserve, Storage.prototype.clear, Storage.prototype.getItem, Storage.prototype.key, Storage.prototype.removeItem, Storage.prototype.setItem, String.fromCodePoint, String.prototype.codePointAt, String.prototype.endsWith, String.prototype.includes, String.prototype.repeat, String.prototype.startsWith, String.raw, TouchEvent.prototype.initTouchEvent, UIEvent.prototype.initUIEvent, XMLHttpRequest.prototype.abort, XMLHttpRequest.prototype.getAllResponseHeaders, XMLHttpRequest.prototype.getResponseHeader, XMLHttpRequest.prototype.open, XMLHttpRequest.prototype.overrideMimeType, XMLHttpRequest.prototype.send, XMLHttpRequest.prototype.setRequestHeader, EventTarget.prototype];
	var preDefNameList = [];
	...
	function isGlobalExcepted(_o, _prop){
        ...
        /*
		if(_o === global){
			for(var i=0; i<__global_except.length; i++){
				var except_m = __global_except[i];
				if(except_m === getOwnPropValue(_o, _prop))
					return true;
			}
		}
		return false;*/
	...
	function init_pred_name(){
		//preDefNameList.push(new pair(HTMLAllCollection.prototype, "HTMLAllCollection"));
		//preDefNameList.push(new pair(HTMLAllCollection.prototype.item, "HTMLAllCollection.item"));
		//preDefNameList.push(new pair(HTMLAllCollection.prototype.namedItem, "HTMLAllCollection.namedItem"));
		// preDefNameList.push(new pair(HTMLAllCollection.prototype.tags, "HTMLAllCollection.tags"));

		preDefNameList.push(new pair(screen, "screenIns"));
		//preDefNameList.push(new pair(Screen.prototype, "screenProto"));

		preDefNameList.push(new pair(console, "ConsoleIns"));
		preDefNameList.push(new pair(console.__proto__.__proto__, "ConsoleProto"));
		//preDefNameList.push(new pair(console.__proto__.__proto__.assert, "Console.assert"));
		//preDefNameList.push(new pair(console.__proto__.__proto__.clear, "Console.clear"));
		//preDefNameList.push(new pair(console.__proto__.__proto__.dir, "Console.dir"));
		//preDefNameList.push(new pair(console.__proto__.__proto__.error, "Console.error"));
		//preDefNameList.push(new pair(console.__proto__.__proto__.info, "Console.info"));
		//preDefNameList.push(new pair(console.__proto__.__proto__.log, "Console.log"));
		//preDefNameList.push(new pair(console.__proto__.__proto__.warn, "Console.warn"));
		...
		// preDefNameList.push(new pair(Node.prototype.getFeature, "DOMNode.getFeature"));
		// preDefNameList.push(new pair(Node.prototype.getUserData, "DOMNode.getUserData"));
		// preDefNameList.push(new pair(Node.prototype.hasAttributes, "DOMNode.hasAttributes"));
		...
		// preDefNameList.push(new pair(Node.prototype.isSupported, "DOMNode.isSupported"));
		...
		// preDefNameList.push(new pair(Node.prototype.setUserData, "DOMNode.setUserData"));
		...
		//preDefNameList.push(new pair(XMLHttpRequest.prototype.addEventListener, "ajax.window.EventTarget.addEventListener"));
		//preDefNameList.push(new pair(XMLHttpRequest.prototype.dispatchEvent, "ajax.window.EventTarget.dispatchEvent"));
		...
		//preDefNameList.push(new pair(XMLHttpRequest.prototype.removeEventListener, "ajax.window.EventTarget.removeEventListener"));
		...
		//preDefNameList.push(new pair(DOMStringMap, "DOMStringMapCons"));
		//preDefNameList.push(new pair(DOMStringMap.prototype, "DOMStringMapProto"));
		...
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.addHitRegion, "CanvasRenderingContext2D.addHitRegion"));
		...
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.createImageDataHD, "CanvasRenderingContext2D.createImageDataHD"));
		...
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.drawCustomFocusRing, "CanvasRenderingContext2D.drawCustomFocusRing"));
		preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.drawImage, "CanvasRenderingContext2D.drawImage"));
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.drawSystemFocusRing, "CanvasRenderingContext2D.drawSystemFocusRing"));
		//preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.ellipse, "CanvasRenderingContext2D.ellipse"));
		...
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.getImageDataHD, "CanvasRenderingContext2D.getImageDataHD"));
		//preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.getLineDash, "CanvasRenderingContext2D.getLineDash"));
		...
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.putImageDataHD, "CanvasRenderingContext2D.putImageDataHD"));
		...
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.removeHitRegion, "CanvasRenderingContext2D.removeHitRegion"));
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.resetClip, "CanvasRenderingContext2D.resetClip"));
		//preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.resetTransform, "CanvasRenderingContext2D.resetTransform"));
		...
		// preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.scrollPathIntoView, "CanvasRenderingContext2D.scrollPathIntoView"));
		//preDefNameList.push(new pair(CanvasRenderingContext2D.prototype.setLineDash, "CanvasRenderingContext2D.setLineDash"));
		...
		//preDefNameList.push(new pair(KeyboardEvent.prototype.getModifierState, "KeyboardEvent.getModifierState"));
		preDefNameList.push(new pair(KeyboardEvent.prototype.initKeyboardEvent, "KeyboardEvent.initKeyboardEvent"));
		// preDefNameList.push(new pair(KeyboardEvent.prototype.initKeyboardEventNS, "KeyboradEvent.initKeyboardEventNS"));
		...
		// preDefNameList.push(new pair(DOMImplementation.prototype.getFeature, "DOMImplementation.getFeature"));
		...
		//preDefNameList.push(new pair(DOMError,"DOMErrorCons"));
		//preDefNameList.push(new pair(DOMError.prototype,"DOMErrorProto"));
		...
		// preDefNameList.push(new pair(Text.prototype.replaceWholeText, "DOMText.replaceWholeText"));
		...
		// preDefNameList.push(new pair(HTMLCanvasElement.prototype.toBlob, "HTMLCanvasElement.toBlob"));
		...
		//preDefNameList.push(new pair(HTMLOptionsCollection, "HTMLOptionsCollectionCons"));
		// preDefNameList.push(new pair(HTMLOptionsCollection.add, "HTMLOptionsCollection.add"));
		// preDefNameList.push(new pair(HTMLOptionsCollection.remove, "HTMLOptionsCollection.remove"));
		//preDefNameList.push(new pair(HTMLOptionsCollection.prototype, "HTMLOptionsCollectionProto"));
		...
		//preDefNameList.push(new pair(Storage, "StorageCons"));
		...
		//preDefNameList.push(new pair(PluginArray, "PluginArrayCons"));
		...
		//preDefNameList.push(new pair(Navigator.prototype, "NavigatorProto"));
		// preDefNameList.push(new pair(Navigator.prototype.isContentHandlerRegistered, "Navigator.isContentHandlerRegistered"));
		// preDefNameList.push(new pair(Navigator.prototype.isProtocolHandlerRegistered, "Navigator.isProtocolHandlerRegistered"));
		//preDefNameList.push(new pair(Navigator.prototype.javaEnabled, "Navigator.javaEnabled"));
		// preDefNameList.push(new pair(Navigator.prototype.registerContentHandler, "Navigator.registerContentHandler"));
		//preDefNameList.push(new pair(Navigator.prototype.registerProtocolHandler, "Navigator.registerProtocolHandler"));
		// preDefNameList.push(new pair(Navigator.prototype.unregisterContentHandler, "Navigator.unregisterContentHandler"));
		//preDefNameList.push(new pair(Navigator.prototype.unregisterProtocolHandler, "Navigator.unregisterProtocolHandler"));
		// preDefNameList.push(new pair(Navigator.prototype.yieldForStorageUpdates, "Navigator.yieldForStorageUpdates"));
        ...
        /*
		preDefNameList.push(new pair(History.prototype, "HistoryProto"));
		preDefNameList.push(new pair(History.prototype.back, "History.back"));
		preDefNameList.push(new pair(History.prototype.forward, "History.forward"));
		preDefNameList.push(new pair(History.prototype.go, "History.go"));
		preDefNameList.push(new pair(History.prototype.pushState, "History.pushState"));
		preDefNameList.push(new pair(History.prototype.replaceState, "History.replaceState"));
        */
		...
		//preDefNameList.push(new pair(HTMLAppletElement, "HTMLAppletElementCons"));
		//preDefNameList.push(new pair(HTMLAppletElement.prototype, "HTMLAppletElementProto"));
		...
		// preDefNameList.push(new pair(CSSStyleDeclaration.prototype.getPropertyCSSValue, "CSSStyleDeclaration.getPropertyCSSValue"));
		...
		//preDefNameList.push(new pair(Location.prototype, "LocationProto"));
		...
		// preDefNameList.push(new pair(Document.prototype.createEntityReference, "DOMDocument.createEntityReference"));
		...
		// preDefNameList.push(new pair(Document.prototype.normalizeDocument, "DOMDocument.normalizeDocument"));
		...
		// preDefNameList.push(new pair(Document.prototype.renameNode, "DOMDocument.renameNode"));
		...
		// preDefNameList.push(new pair(Element.prototype.setIdAttribute, "DOMElement.setIdAttribute"));
		// preDefNameList.push(new pair(Element.prototype.setIdAttributeNS, "DOMElement.setIdAttributeNS"));
		// preDefNameList.push(new pair(Element.prototype.setIdAttributeNode, "DOMElement.setIdAttributeNode"));
		...
		// preDefNameList.push(new pair(global.back, "DOMWindow.back"));
		...
		// preDefNameList.push(new pair(global.forward, "DOMWindow.forward"));
		preDefNameList.push(new pair(global.getComputedStyle, "DOMWindow.getComputedStyle"));
		// preDefNameList.push(new pair(global.home, "DOMWindow.home"));
		...
		// preDefNameList.push(new pair(global.maximize, "DOMWindow.maximize"));
		// preDefNameList.push(new pair(global.minimize, "DOMWindow.minimize"));
		...
		// preDefNameList.push(new pair(global.scrollByLines, "DOMWindow.scrollByLines"));
		// preDefNameList.push(new pair(global.scrollByPages, "DOMWindow.scrollByPages"));
		...
		//preDefNameList.push(new pair(__interval_info, "Interval"));
		//preDefNameList.push(new pair(__timeout_info, "Timeout"));
...
/*        try {
            new _obj;
            putPropValue(_obj, interPS + "construct", true);
        } catch (e) {
        }*/
   ...
   /* Initialize routines for SAFE*/
	...
	// function assignNativeNames(undefined){
	// 	var stack = [];
	// 	var tstack = [];
	// 	var objnames = [];
	//
	...
	//
	// 	assign(global, "");
	// 	assign(Object.prototype, "Object.prototype");
	// 	stack.push(Object.prototype);
	// 	var obj = global;
	// 	var name = "";
	//
	// 	do{
	...
	// 			var prop = props[i];
	//
	// 			if(obj === global && (prop === "clientInformation" || prop === "navigator" || prop.indexOf("__") == 0))
	// 				continue;
	//
	// 			var m = Object.getOwnPropertyDescriptor(obj,prop).value;
	//
	// 			if((m !== null || m !== undefined) && m instanceof Object && named(m) === false){
	// 				tstack.push(m);
	// 				var new_name = (name === "")? prop : name + "." + prop;
	// 				assign(m, new_name);
	// 				if(typeof m === 'function' && isNative(m)){
	// 					console.log("#name: "+new_name);
	// 					putPropValue(m, "@funcname", new_name);
	// 				}
	// 			}
	// 		}
	//
