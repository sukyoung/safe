...
using \textit{{\sealed} values}.  \inred{A {\sealed} value is a symbol
...
SAFE \inred{6.30$\x$} on average.  Moreover, by using dynamic shortcuts
instead of manual modeling for \inred{12} opaque functions,
$\tool$ improves the analysis precision to \inred{reduce assertion fails by 12\%} on
average.
\end{itemize}
