...
Jalangi is \inred{X.X}x faster than the static analyzer SAFE for V8 benchmarks
...
and Jalangi and analyzed \inred{77} official tests of Lodash 4 library.
...
\inred{Lodash 4} library.  The experiment shows that $\tool$ outperforms
...
$\tool$ improves \inred{XX.XX}\% of the analysis precision on average.
\end{itemize}
