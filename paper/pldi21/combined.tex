...
We define a \textit{sealed symbolic execution} by extending the transition
...
symbolic transition relation with a single symbolic state, and the sealed
symbolic execution is linear until reaching the exception state.
...
configure when the sealed symbolic execution or the abstract interpretation
