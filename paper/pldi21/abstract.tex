...
We formally present the alloyed analysis, a more flexible compound of static and dynamic analyses.
...
Our experimental results show that the alloyed analysis indeed speeds up the detection and reports bugs more precisely.
\end{abstract}
