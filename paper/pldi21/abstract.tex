...
\inred{77} official tests of Lodash 4 library.
Our experiment shows that $\tool$ is \inred{X.X}x faster than the
baseline static analyzer on average, and it improves \inred{XX.XX}\%
of the analysis precision on average by using sealed symbolic
execution for \inred{XX.X} opaque functions.
\end{abstract}
